...
// Type: Telerik.Sitefinity.Web.UI.Backend.Elements.Definitions.ContentFilteringWidgetDefinition
...
namespace Telerik.Sitefinity.Web.UI.Backend.Elements.Definitions
{
  ...
  internal class ContentFilteringWidgetDefinition : 
    ...
    IDefinition
  {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Web.UI.Backend.Elements.Definitions.ContentFilteringWidgetDefinition" /> class.
    /// </summary>
    public ContentFilteringWidgetDefinition()
    ...
    public ContentFilteringWidgetDefinition(ConfigElement configDefinition)
    ...
    public List<FilterRangeDefinition> PredefinedFilteringRanges
    {
      get
      {
        if (this.predefinedFilteringRanges == null)
        {
          ...
          {
            foreach (DefinitionConfigElement predefinedFilteringRange in ((ContentFilteringWidgetDefinitionElement) this.ConfigDefinition).PredefinedFilteringRanges)
