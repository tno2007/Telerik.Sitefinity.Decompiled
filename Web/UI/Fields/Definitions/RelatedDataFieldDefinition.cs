...
// Type: Telerik.Sitefinity.Web.UI.Fields.Definitions.RelatedDataFieldDefinition
...
{
  /// <summary>
  ///  A class that provides all information needed to construct a related data field control.
  /// </summary>
  public class RelatedDataFieldDefinition : 
    ...
    IDefinition
  {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Web.UI.Fields.Definitions.RelatedDataFieldDefinition" /> class.
    /// </summary>
    public RelatedDataFieldDefinition()
    {
    }
    ...
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Web.UI.Fields.Definitions.RelatedDataFieldDefinition" /> class.
    /// </summary>
    public RelatedDataFieldDefinition(ConfigElement configDefinition)
