...
Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormTextBoxLabelView=function(element){Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormTextBoxLabelView.initializeBase(this,[element]);
...
Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormTextBoxLabelView.prototype={initialize:function(){Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormTextBoxLabelView.callBaseMethod(this,"initialize");
...
},dispose:function(){Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormTextBoxLabelView.callBaseMethod(this,"dispose");
...
},_validate:function(){var limitationsView=this._getFormTextBoxLimitationsView();
...
},_getFormTextBoxLimitationsView:function(){var parent=this.get_propertyEditor().get_designer();
if(parent){var formTextBoxLimitationsViewId=parent.get_designerViewsMap()["FormTextBoxLimitationsView"];
