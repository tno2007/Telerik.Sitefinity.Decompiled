...
// Type: Telerik.Sitefinity.Fluent.ContentFluentApi.ImageDraftFacade`1
...
{
  /// <summary>Manage the draft state of an image</summary>
  /// <typeparam name="TParentFacade"></typeparam>
  public class ImageDraftFacade<TParentFacade> : 
    MediaDraftFacade<ImageDraftFacade<TParentFacade>, TParentFacade, Image, ImageTempFacade<ImageDraftFacade<TParentFacade>>, ImagePublicFacade<ImageDraftFacade<TParentFacade>>>,
    ISupportVersioning<ImageDraftFacade<TParentFacade>>
    where TParentFacade : BaseFacade
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Fluent.ContentFluentApi.ImageDraftFacade`1" /> class.
    /// </summary>
    ...
    public ImageDraftFacade(AppSettings settings)
      : base(settings)
    {
    }
    ...
    /// <exception cref="T:System.ArgumentNullException">When <paramref name="settings" /> is null</exception>
    /// <exception cref="T:System.ArgumentException">When <paramref name="settings" />'s transaction name is null or empty</exception>
    public ImageDraftFacade(AppSettings settings, TParentFacade parentFacade)
    ...
    /// <exception cref="T:System.ArgumentException">When <paramref name="settings" />'s transaction name is null or empty</exception>
    public ImageDraftFacade(AppSettings settings, TParentFacade parentFacade, Guid itemID)
    ...
    /// <exception cref="T:System.ArgumentNullException">When <paramref name="settings" /> or <paramref name="item" /> is null</exception>
    /// <exception cref="T:System.ArgumentException">When <paramref name="settings" />'s transaction name is null or empty</exception>
    public ImageDraftFacade(AppSettings settings, TParentFacade parentFacade, Image item)
    ...
    public virtual VersioningFacade<ImageDraftFacade<TParentFacade>> Versioning() => new VersioningFacade<ImageDraftFacade<TParentFacade>>(this.settings, this, (IDataItem) this.Get());
  }
}
