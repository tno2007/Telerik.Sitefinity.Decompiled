...
Telerik.Sitefinity.Modules.Pages.Web.UI.ShareLinkDialog=function(element){Telerik.Sitefinity.Modules.Pages.Web.UI.ShareLinkDialog.initializeBase(this,[element]);
this._closeButton=null;
this._closeDelegate=null;
this._loadDelegate=null;
this._txtSharedLink="";
};
Telerik.Sitefinity.Modules.Pages.Web.UI.ShareLinkDialog.prototype={initialize:function(){this._closeDelegate=Function.createDelegate(this,this._closeDialogHandler);
...
},dispose:function(){if(this._closeDelegate){delete this._closeDelegate;
...
},_closeDialogHandler:function(){dialogBase.close();
},_txtSharedLinkClick:function(){this.focus();
this.select();
},get_closeButton:function(){return this._closeButton;
},set_closeButton:function(value){this._closeButton=value;
},get_txtSharedLink:function(){return this._txtSharedLink;
},set_txtSharedLink:function(value){this._txtSharedLink=value;
}};
