...
// Type: Telerik.Sitefinity.Web.UI.ContentUI.Views.Backend.Master.Contracts.IGridViewModeDefinition
...
namespace Telerik.Sitefinity.Web.UI.ContentUI.Views.Backend.Master.Contracts
{
  ...
  /// </summary>
  public interface IGridViewModeDefinition : IViewModeDefinition, IDefinition
  {
    /// <summary>
    /// Gets the collection of column definitions that are displayed on the view.
    /// </summary>
    List<IColumnDefinition> Columns { get; }
  }
}
