...
// Type: Telerik.Sitefinity.Web.UI.NavigationControls.SiteTree
...
{
  /// <summary>
  /// Wrapper around Telerik's <see cref="T:Telerik.Web.UI.RadTreeView" /> control which provides a navigational
  /// control for Sitefinity.
  /// </summary>
  public class SiteTree : RadTreeView
  {
