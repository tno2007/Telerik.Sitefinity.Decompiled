...
// Type: Telerik.Sitefinity.Model.SitefinityMetadataSource
...
{
  public class SitefinityMetadataSource : SitefinityMetadataSourceBase
  {
    public SitefinityMetadataSource(IDatabaseMappingContext context)
      : base(context)
    {
    }
