...
Telerik.Sitefinity.Web.UI.Backend.Elements.CustomSortingDialog=function(element){Telerik.Sitefinity.Web.UI.Backend.Elements.CustomSortingDialog.initializeBase(this,[element]);
...
Telerik.Sitefinity.Web.UI.Backend.Elements.CustomSortingDialog.prototype={initialize:function(){if(this._commandBarCommandDelegate==null){this._commandBarCommandDelegate=Function.createDelegate(this,this.commandBar_Command);
}if(this._commandBar!=null){this._commandBar.add_command(this._commandBarCommandDelegate);
}if(this._removeAllSortConditionDelegate===null){this._removeAllSortConditionDelegate=Function.createDelegate(this,this._removeAllSortConditionHandler);
}if(this._removeAllLink!=null){$addHandler($get(this._removeAllLink),"click",this._removeAllSortConditionDelegate);
...
}if(this._removeAllSortConditionDelegate!=null){delete this._removeAllSortConditionDelegate;
...
}},buildSortConditions:function(){this._sortConditionControl=new Telerik.Sitefinity.Web.UI.Backend.Elements.SortCondition(this._containerId,this._sortExpression,this._typeProperties,this._removeAllLink);
...
},commandBar_Command:function(sender,args){switch(args.get_commandName()){case"save":this._saveSortExpression();
break;
case"cancel":this.close();
break;
}},_prepareDialogHandler:function(){if(this._sortConditionControl){this._sortConditionControl.buildUI();
}},_removeAllSortConditionHandler:function(){if(this._sortConditionControl){this._sortConditionControl.reset();
}dialogBase.resizeToContent();
},_resizeToContent:function(){dialogBase.resizeToContent();
},_saveSortExpression:function(){var sortExpression="";
if(this._sortConditionControl){sortExpression=this._sortConditionControl.getSortExpression();
...
},set_typeProperties:function(value){this._typeProperties=value;
