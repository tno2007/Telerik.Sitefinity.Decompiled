...
Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.DocumentSelectorDesignerView = function (element) {
    Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.DocumentSelectorDesignerView.initializeBase(this, [element]);
...
Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.DocumentSelectorDesignerView.prototype = {

    initialize: function () {
        Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.DocumentSelectorDesignerView.callBaseMethod(this, "initialize");
    ...
    dispose: function () {
        Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.DocumentSelectorDesignerView.callBaseMethod(this, "dispose");
    ...
    applyChanges: function () {
        if (this.get_selectedDataItem()) {
            this.get_controlData().DocumentId = this.get_selectedDataItem().Id;
        }
    },
