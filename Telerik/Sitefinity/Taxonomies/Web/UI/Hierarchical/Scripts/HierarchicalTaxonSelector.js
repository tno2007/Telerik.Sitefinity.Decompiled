...
}},_set_createTaxonButtonText:function(){if(this._controlLoaded){if(this._createTaxonButtonText){this._createTaxonButton.innerHTML=String.format(this._createTaxonButtonTextTemplate,this.get_createTaxonButtonText().htmlEncode());
}else{this._createTaxonButton.innerHTML=String.format(this._createTaxonButtonTextTemplate,"");
