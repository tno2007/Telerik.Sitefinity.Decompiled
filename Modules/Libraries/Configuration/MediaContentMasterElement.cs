...
// Type: Telerik.Sitefinity.Modules.Libraries.Configuration.MediaContentMasterElement
...
{
  /// <summary>
  /// The configuration element for MediaContentMasterDefinition
  /// </summary>
  public class MediaContentMasterElement : 
  ...
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Modules.Libraries.Configuration.MediaContentMasterElement" /> class.
    /// </summary>
    /// <param name="element">The element.</param>
    public MediaContentMasterElement(ConfigElement element)
      : base(element)
    {
    }
    ...
    /// <returns></returns>
    public override DefinitionBase GetDefinition() => (DefinitionBase) new MediaContentMasterDefinition((ConfigElement) this);
    ...
    /// <value></value>
    [ConfigurationProperty("thumbnailsWidth", IsRequired = false)]
    [ObjectInfo(typeof (ConfigDescriptions), Description = "ThumbnailsWidthDescription", Title = "ThumbnailsWidthCaption")]
    [Obsolete("Use ThumbnailsName to define the thumbnails settings(profile/size) you want to use.")]
    public int? ThumbnailsWidth
    {
      get => (int?) this["thumbnailsWidth"];
      set => this["thumbnailsWidth"] = (object) value;
    }

    /// <summary>Gets or sets the name of the thumbnail.</summary>
    /// <value>The name of the thumbnail.</value>
    [ConfigurationProperty("thumbnailName", IsRequired = false)]
    [ObjectInfo(typeof (ConfigDescriptions), Description = "ThumbnailsNameDescription", Title = "ThumbnailsNameCaption")]
    public string ThumbnailsName
    {
      get => (string) this["thumbnailName"];
      set => this["thumbnailName"] = (object) value;
    }

    /// <summary>
    /// Constants to hold the string keys for configuration properties of MediaContentMasterElement
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Size = 1)]
    internal struct MediaContentMasterProps
    {
      public const string SingleItemWidth = "singleItemWidth";
      public const string SingleItemThumbnailsName = "singleItemThumbnailsName";
      public const string ThumbnailsWidth = "thumbnailsWidth";
      public const string ThumbnailsName = "thumbnailName";
    }
  }
}
