...
Telerik.Sitefinity.Modules.Libraries.Web.UI.ThumbnailMediaPlayerDialog=function(element){Telerik.Sitefinity.Modules.Libraries.Web.UI.ThumbnailMediaPlayerDialog.initializeBase(this,[element]);
...
Telerik.Sitefinity.Modules.Libraries.Web.UI.ThumbnailMediaPlayerDialog.prototype={initialize:function(){Telerik.Sitefinity.Modules.Libraries.Web.UI.ThumbnailMediaPlayerDialog.callBaseMethod(this,"initialize");
...
if(this._doneButton){if(this._doneClientSelectionDelegate==null){this._doneClientSelectionDelegate=Function.createDelegate(this,this._handleDoneClientSelection);
}$addHandler(this._doneButton,"click",this._doneClientSelectionDelegate);
}if(this._cancelButton){if(this._cancelClientSelectionDelegate==null){this._cancelClientSelectionDelegate=Function.createDelegate(this,this._handleCancelClientSelection);
...
}if(this._doneClientSelectionDelegate!=null){delete this._doneClientSelectionDelegate;
}Telerik.Sitefinity.Modules.Libraries.Web.UI.ThumbnailMediaPlayerDialog.callBaseMethod(this,"dispose");
},loadDialog:function(){var url=dialogBase.getQueryValue("mediaUrl",true);
var data={url:unescape(url),title:"",description:"",autoPlay:"true"};
if(this._mediaPlayer){this._mediaPlayer.setMediaParams(data);
}},_handleDoneClientSelection:function(){this._mediaPlayer._clearMediaItem();
var data=this._mediaPlayer.getThumbnailData();
if(data){var arg={Data:data};
this.close(arg);
}else{this.close();
}},_handleCancelClientSelection:function(){this._mediaPlayer._clearMediaItem();
this.close();
