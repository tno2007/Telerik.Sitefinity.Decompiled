...
// Type: Telerik.Sitefinity.Web.UI.Fields.Designers.CheckboxesDesigner
...
{
  /// <summary>Content view designer for Checkboxes control</summary>
  public class CheckboxesDesigner : ContentViewDesignerBase
  {
    /// <inheritdoc />
    ...
    {
      ChoiceFieldLabelsView choiceFieldLabelsView = new ChoiceFieldLabelsView();
