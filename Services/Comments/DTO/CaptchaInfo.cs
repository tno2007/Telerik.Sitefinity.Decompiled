...
// Type: Telerik.Sitefinity.Services.Comments.DTO.CaptchaInfo
...
namespace Telerik.Sitefinity.Services.Comments.DTO
{
  ...
  /// </summary>
  [Obsolete("Use Telerik.Sitefinity.Services.Captcha.DTO.CaptchaInfo instead")]
  public class CaptchaInfo
  {
    ...
    /// This is a system property that contains the hashed correct answer for the loaded captha.
    /// </summary>
