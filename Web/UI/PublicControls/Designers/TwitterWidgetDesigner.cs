...
// Type: Telerik.Sitefinity.Web.UI.PublicControls.Designers.TwitterWidgetDesigner
...
namespace Telerik.Sitefinity.Web.UI.PublicControls.Designers
{
  public class TwitterWidgetDesigner : ControlDesignerBase
  {
    ...
    public static readonly string layoutTemplatePath = ControlUtilities.ToVppPath("Telerik.Sitefinity.Resources.Templates.Designers.EmbedControls.TwitterWidgetDesigner.ascx");
    internal const string designerViewJs = "Telerik.Sitefinity.Web.UI.PublicControls.Designers.Scripts.TwitterWidgetDesigner.js";
    ...
    {
      get => string.IsNullOrEmpty(base.LayoutTemplatePath) ? TwitterWidgetDesigner.layoutTemplatePath : base.LayoutTemplatePath;
      set => base.LayoutTemplatePath = value;
    }

    /// <summary>Represents the text filed that holds the CSS styles</summary>
    protected internal virtual TextField TwitterCodeTextField => this.Container.GetControl<TextField>("twitterCodeTextField", true);
    ...
    public override IEnumerable<ScriptDescriptor> GetScriptDescriptors()
    {
      ...
      controlDescriptor.AddComponentProperty("twitterCodeTextField", this.TwitterCodeTextField.ClientID);
    ...
    public override IEnumerable<ScriptReference> GetScriptReferences()
    {
      ...
      scriptReferences.Add(new ScriptReference("Telerik.Sitefinity.Web.UI.PublicControls.Designers.Scripts.TwitterWidgetDesigner.js", this.GetType().Assembly.GetName().ToString()));
