...
// Type: Telerik.Sitefinity.Publishing.Data.PublishingMetadataSource
...
{
  public class PublishingMetadataSource : SecuredProviderMetadataSource
  {
    public PublishingMetadataSource(IDatabaseMappingContext context)
      : base(context)
    {
    }
    ...
    protected override IList<IOpenAccessFluentMapping> BuildCustomMappings()
    {
      ...
      accessFluentMappingList.Add((IOpenAccessFluentMapping) new PublishingFluentMapping(this.Context));
