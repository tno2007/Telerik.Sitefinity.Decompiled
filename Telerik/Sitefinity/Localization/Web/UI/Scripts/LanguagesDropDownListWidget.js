...
Telerik.Sitefinity.Localization.Web.UI.LanguagesDropDownListWidget=function(element){Telerik.Sitefinity.Localization.Web.UI.LanguagesDropDownListWidget.initializeBase(this,[element]);
...
Telerik.Sitefinity.Localization.Web.UI.LanguagesDropDownListWidget.prototype={initialize:function(){Telerik.Sitefinity.Localization.Web.UI.LanguagesDropDownListWidget.callBaseMethod(this,"initialize");
...
},_handlePageLoad:function(sender,args){this._languagesList=$find(this._languagesListId);
this._languagesList.add_languageChanged(this._languageChangedDelegate);
},_languageChanged:function(sender,args){var commandEventArgs=new Telerik.Sitefinity.CommandEventArgs(this._commandName,args.get_value());
...
},get_languagesListId:function(){return this._languagesListId;
},set_languagesListId:function(value){this._languagesListId=value;
}};
