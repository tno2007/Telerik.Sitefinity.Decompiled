...
// Type: Telerik.Sitefinity.Fluent.Definitions.Fields.WarningDefinitionFacade`1
...
{
  /// <summary>
  /// Fluent API facade wrapping <c>WarningFieldElement</c>
  /// </summary>
  /// <typeparam name="TParentFacade">The type of the parent facade.</typeparam>
  public class WarningDefinitionFacade<TParentFacade> : 
    FieldControlDefinitionFacade<WarningFieldElement, WarningDefinitionFacade<TParentFacade>, TParentFacade>
    where TParentFacade : class
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Fluent.Definitions.Fields.WarningDefinitionFacade`1" /> class.
    /// </summary>
    ...
    public WarningDefinitionFacade(
      string moduleName,
      ...
      : base(moduleName, definitionName, contentType, parentElement, viewName, sectionName, parentFacade, fieldName, resourceClassId, mode)
    {
      ...
      this.Field.FieldType = typeof (WarningField);
    }

    /// <summary>Creates the config.</summary>
    /// <param name="parentElement">The parent element.</param>
    /// <returns>New instance of the parent config element.</returns>
    protected override WarningFieldElement CreateConfig(
      ConfigElementDictionary<string, FieldDefinitionElement> parentElement)
    {
      return new WarningFieldElement((ConfigElement) parentElement);
    }
  }
}
