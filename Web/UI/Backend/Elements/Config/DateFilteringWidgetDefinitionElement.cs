...
// Type: Telerik.Sitefinity.Web.UI.Backend.Elements.Config.DateFilteringWidgetDefinitionElement
...
namespace Telerik.Sitefinity.Web.UI.Backend.Elements.Config
{
  ...
  /// </summary>
  public class DateFilteringWidgetDefinitionElement : 
    ...
    IDefinition
  {
    ...
    public DateFilteringWidgetDefinitionElement(ConfigElement parentElement)
      : base(parentElement)
    {
    }
    ...
    /// <returns></returns>
    public override DefinitionBase GetDefinition() => (DefinitionBase) new DateFilteringWidgetDefinition((ConfigElement) this);
    ...
    public ConfigElementList<FilterRangeElement> PredefinedFilteringRanges => (ConfigElementList<FilterRangeElement>) this["predefinedFilteringRanges"];
