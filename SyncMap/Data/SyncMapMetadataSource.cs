...
// Type: Telerik.Sitefinity.SyncMap.Data.SyncMapMetadataSource
...
{
  internal class SyncMapMetadataSource : ContentBaseMetadataSource
  {
    public SyncMapMetadataSource(IDatabaseMappingContext context)
      : base(context)
    {
    }
    ...
    protected override IList<IOpenAccessFluentMapping> BuildCustomMappings()
    {
      ...
      accessFluentMappingList.Add((IOpenAccessFluentMapping) new SyncMapFluentMapping(this.Context));
