...
// Type: Telerik.Sitefinity.Web.Services.Extensibility.FormTitleProperty
...
namespace Telerik.Sitefinity.Web.Services.Extensibility
{
  ...
  internal class FormTitleProperty : CalculatedProperty
  {
      ...
      IManager manager)
    {
      ...
      {
        if (key != null)
          values.Add((object) key, (object) key.ParentForm.Title);
      }
