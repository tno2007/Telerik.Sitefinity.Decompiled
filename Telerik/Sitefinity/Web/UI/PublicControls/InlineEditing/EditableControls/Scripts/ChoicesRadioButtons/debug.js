define(["EditableWindowField", "text!ChoicesRadioButtonsTemplate!strip"], function (EditableWindowField, html) {
    function ChoicesRadioButtons(options) {
