...
Telerik.Sitefinity.Web.UI.Fields.GenericHierarchicalField=function(element){this._element=element;
...
Telerik.Sitefinity.Web.UI.Fields.GenericHierarchicalField.prototype={initialize:function(){this._clientManager=new Telerik.Sitefinity.Data.ClientManager();
if(this._loadDelegate==null){this._loadDelegate=Function.createDelegate(this,this._load);
}Sys.Application.add_load(this._loadDelegate);
if(this._changeSelectedNodeClickDelegate==null){this._changeSelectedNodeClickDelegate=Function.createDelegate(this,this._changeSelectedNodeClick);
...
}if(this._nodesRootChoiceChangedDelegate==null){this._nodesRootChoiceChangedDelegate=Function.createDelegate(this,this._handleNodesRootChoiceChanged);
...
}if(this._selectionDoneDelegate!=null){this._nodeSelector.remove_selectionDone(this._selectionDoneDelegate);
delete this._selectionDoneDelegate;
}if(this._nodesRootChoiceChangedDelegate!=null){this._nodeSelector.remove_nodesRootChoiceChanged(this._nodesRootChoiceChangedDelegate);
...
},set_rootNodeId:function(value){this._rootNodeId=value;
},get_rootNode:function(){return this._rootNode;
},set_rootNode:function(value){this._rootNode=value;
...
},get_value:function(){if(this._selectedNode!=null){return this._selectedNode;
...
if(this._dataItem){this._dataItem.Parent=this._selectedNode;
if(this._selectedNode){this._dataItem.ParentId=this._selectedNode.Id;
}else{this._dataItem.ParentId="00000000-0000-0000-0000-000000000000";
}}if(this._selectedNode&&this._selectedNode.Id!=this._rootNodeId){if(this._selectedNode.hasOwnProperty(this._selectedNodeDataFieldName)){$(this._selectedNodeLabel).text(this._selectedNode[this._selectedNodeDataFieldName]);
}else{$(this._selectedNodeLabel).text(this._selectedNode.Title);
...
},reset:function(){Telerik.Sitefinity.Web.UI.Fields.GenericHierarchicalField.callBaseMethod(this,"reset");
this.clearSelection();
...
if(context.ParentId=="00000000-0000-0000-0000-000000000000"){context=null;
...
this._nodeSelector.hideTreePanel();
$(this._selectedNodePanel).show();
},_selectorDataBoundHandler:function(sender,args){if(this._dataItem&&this._dataItem.Parent&&this._dataItem.Parent.Id){var currentlySelectedNode=this._getSelectorNode(sender,this._dataItem.Parent.Id);
...
if(this._dataItem&&dataItem.Id===this._dataItem.Id&&!this._dataItem.IsDuplicate){var nodeToDisable=this._getSelectorNode(sender,dataItem.Id);
...
if(args&&args.commandName=="create"){if(args.selectedNode){this._setValueInternal(args.selectedNode);
...
},get_selectedNodeDataFieldName:function(){return this._selectedNodeDataFieldName;
},set_selectedNodeDataFieldName:function(value){this._selectedNodeDataFieldName=value;
}};
