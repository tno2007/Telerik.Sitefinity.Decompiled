...
// Type: Telerik.Sitefinity.Modules.Libraries.Configuration.DownloadListViewDetailElement
...
{
  /// <summary>
  /// The configuration element for DownloadListViewDetailDefinition
  /// </summary>
  public class DownloadListViewDetailElement : 
  ...
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Modules.Libraries.Configuration.DownloadListViewDetailElement" /> class.
    /// </summary>
    /// <param name="element">The element.</param>
    public DownloadListViewDetailElement(ConfigElement element)
      : base(element)
    {
    }
    ...
    /// <returns></returns>
    public override DefinitionBase GetDefinition() => (DefinitionBase) new DownloadListViewDetailDefinition((ConfigElement) this);
    ...
    /// </summary>
    [ConfigurationProperty("thumbnailType", DefaultValue = ThumbnailType.SmallIcons, IsRequired = false)]
    ...
    /// <summary>
    /// Constants to hold the string keys for configuration properties of ContentViewDetailElement
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Size = 1)]
    internal struct DownloadListViewDetailProps
    {
