...
// Type: Telerik.Sitefinity.Fluent.ContentFluentApi.IBaseContentSingularFacade`2
...
namespace Telerik.Sitefinity.Fluent.ContentFluentApi
{
  ...
  public interface IBaseContentSingularFacade<TCurrentFacade, TContent>
    ...
    where TContent : IDataItem
  {
    ...
    TCurrentFacade Do(Action<TContent> setAction);
    ...
    /// <returns>An instance of the current facade type.</returns>
    TCurrentFacade Set(TContent item);
  }
}
