...
// Type: Telerik.Sitefinity.Data.WcfHelpers.AllowDynamicFieldsAttribute
...
namespace Telerik.Sitefinity.Data.WcfHelpers
{
  ...
  public sealed class AllowDynamicFieldsAttribute : 
    Attribute,
    IContractBehavior,
    IOperationBehavior,
    IWsdlExportExtension
  {
      ...
      ClientRuntime clientRuntime)
    {
      foreach (OperationDescription operation in (Collection<OperationDescription>) contractDescription.Operations)
        AllowDynamicFieldsAttribute.ApplyDataContractSurrogate(operation);
    }
    ...
    {
      AllowDynamicFieldsAttribute.ApplyDataContractSurrogate(operationDescription);
    }
    ...
    public void ExportContract(WsdlExporter exporter, WsdlContractConversionContext context)
    {
      ...
      if (contractExporter.Options.DataContractSurrogate != null)
        return;
      contractExporter.Options.DataContractSurrogate = (IDataContractSurrogate) new DynamicFieldsDataContractSurrogate();
    }
    ...
    private static void ApplyDataContractSurrogate(OperationDescription description)
    {
      ...
      if (operationBehavior == null || operationBehavior.DataContractSurrogate != null)
        return;
      operationBehavior.DataContractSurrogate = (IDataContractSurrogate) new DynamicFieldsDataContractSurrogate();
    }
  }
}
