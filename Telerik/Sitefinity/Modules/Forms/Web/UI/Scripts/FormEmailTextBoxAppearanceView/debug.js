...
Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormEmailTextBoxAppearanceView = function (element) {
    Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormEmailTextBoxAppearanceView.initializeBase(this, [element]);
    this._textBoxSizeChoiceField = null;
    this._cssClassTextField = null;
}

Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormEmailTextBoxAppearanceView.prototype = {
    /* --------------------------------- set up and tear down --------------------------------- */
    initialize: function () {
        Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormEmailTextBoxAppearanceView.callBaseMethod(this, 'initialize');
    },

    dispose: function () {
        Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormEmailTextBoxAppearanceView.callBaseMethod(this, 'dispose');
    },
    ...
    refreshUI: function () {
        ...
        if (this._textBoxSizeChoiceField) {
            this._textBoxSizeChoiceField.set_value(controlData.TextBoxSize);
        }
    },
    ...
    applyChanges: function () {
        ...
        if (this._textBoxSizeChoiceField) {
            controlData.TextBoxSize = this._textBoxSizeChoiceField.get_value();
        }
    },
