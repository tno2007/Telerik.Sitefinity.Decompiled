...
// Type: Telerik.Sitefinity.IContentLifecycleManager
...
{
  /// <summary>
  /// Marker interface for all managers that support the content lifecycle functionality.
  /// </summary>
  [Obsolete("Use Telerik.Sitefinity.Lifecycle.ILifecycleManager")]
  public interface IContentLifecycleManager : IManager, IDisposable, IProviderResolver
  {
    /// <summary>
    ...
    bool IsCheckedOut(Content item);
    ...
    bool IsCheckedOutBy(Content item, Guid userId);
    ...
    void Copy(Content source, Content destination);
  }
}
