...
// Type: Telerik.Sitefinity.Processors.Configuration.ProcessorConfigElement
...
namespace Telerik.Sitefinity.Processors.Configuration
{
  ...
  /// </summary>
  public class ProcessorConfigElement : ConfigElement
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Processors.Configuration.ProcessorConfigElement" /> class.
    /// </summary>
    /// <param name="parent">The parent element.</param>
    public ProcessorConfigElement(ConfigElement parent)
      : base(parent)
    {
    }
