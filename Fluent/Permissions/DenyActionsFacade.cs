...
// Type: Telerik.Sitefinity.Fluent.Permissions.DenyActionsFacade
...
namespace Telerik.Sitefinity.Fluent.Permissions
{
  ...
  /// </summary>
  public class DenyActionsFacade : ActionsFacadeBase
  {
    /// <summary>
    ...
    {
      permission.UngrantActions(action);
      permission.DenyActions(true, action);
    }
  }
}
