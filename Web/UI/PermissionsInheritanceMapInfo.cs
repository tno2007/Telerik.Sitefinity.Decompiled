...
// Type: Telerik.Sitefinity.Web.UI.PermissionsInheritanceMapInfo
...
{
  /// <summary>
  /// Holds permission inheritance map info in memory without any tracking or persistence and can be used in asp.net markup
  /// </summary>
  public class PermissionsInheritanceMapInfo : PermissionsInheritanceMap
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Web.UI.PermissionsInheritanceMapInfo" /> class.
    /// </summary>
    public PermissionsInheritanceMapInfo()
    {
    }

    /// <summary>Create a copy of an existing map</summary>
    /// <param name="original">Existing map</param>
    public PermissionsInheritanceMapInfo(PermissionsInheritanceMap original)
    {
