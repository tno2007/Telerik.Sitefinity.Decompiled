...
// Type: Telerik.Sitefinity.Fluent.ContentFluentApi.GenericContentTempFacade`1
...
{
  /// <summary>Manages the temp state of a generic content item</summary>
  /// <typeparam name="TParentFacade">The type of the parent facade.</typeparam>
  public class GenericContentTempFacade<TParentFacade> : 
    BaseTempFacade<GenericContentTempFacade<TParentFacade>, TParentFacade, ContentItem, GenericContentPublicFacade<TParentFacade>>,
    ISupportVersioning<GenericContentTempFacade<TParentFacade>>
  ...
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Fluent.ContentFluentApi.GenericContentTempFacade`1" /> class.
    /// </summary>
    ...
    public GenericContentTempFacade(AppSettings settings)
      : base(settings)
    {
    }
    ...
    /// <exception cref="T:System.ArgumentNullException">When <paramref name="settings" /> is null</exception>
    /// <exception cref="T:System.ArgumentException">When <paramref name="settings" />'s transaction name is null or empty</exception>
    public GenericContentTempFacade(AppSettings settings, TParentFacade parentFacade)
    ...
    public GenericContentTempFacade(AppSettings settings, TParentFacade parentFacade, Guid itemID)
    ...
    /// <exception cref="T:System.ArgumentException">When <paramref name="settings" />'s transaction name is null or empty</exception>
    public GenericContentTempFacade(
    ...
    public virtual VersioningFacade<GenericContentTempFacade<TParentFacade>> Versioning() => new VersioningFacade<GenericContentTempFacade<TParentFacade>>(this.settings, this, (IDataItem) this.Get());
  }
}
