define(["FlatContentSelector"],function(FlatContentSelector){function ProvidersSelector(parentElement){FlatContentSelector.call(this,parentElement);
...
return(this);
}ProvidersSelector.prototype={parameterMapFunc:function(options){var queryObj={sortExpression:"Title ASC",dataSourceName:this.dataSourceName,useCurrentSite:true};
if(this.isSearchRequest()){queryObj.skip=0;
queryObj.take=20;
...
},resolveUrlFunc:function(options){return this.getServiceUrl();
}};
