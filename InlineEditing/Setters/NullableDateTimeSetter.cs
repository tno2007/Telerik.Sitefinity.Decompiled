...
// Type: Telerik.Sitefinity.InlineEditing.Setters.NullableDateTimeSetter
...
{
  internal class NullableDateTimeSetter : PropertySetterBase
  {
    ...
    {
      if (!string.IsNullOrWhiteSpace(field.Value as string))
      {
