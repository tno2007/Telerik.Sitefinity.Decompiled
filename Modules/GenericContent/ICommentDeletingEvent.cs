...
// Type: Telerik.Sitefinity.Modules.GenericContent.Events.ICommentDeletingEvent
...
{
  /// <summary>
  /// This event is raised during event deletion, before the transaction is completed.
  ...
  public interface ICommentDeletingEvent : 
    ICommentDeleteEvent,
    ICommentEvent,
    IEvent,
    IPreProcessingEvent
  {
    /// <summary>The comment being deleted.</summary>
