...
// Type: Telerik.Sitefinity.Modules.GenericContent.Events.ICommentDeleteEvent
...
{
  /// <summary>Base interface for the comment deletion events.</summary>
  [Obsolete("Use Telerik.Sitefinity.Services.Comments.ICommentDeletingEvent and ICommentDeletedEvent.")]
  public interface ICommentDeleteEvent : ICommentEvent, IEvent
  {
