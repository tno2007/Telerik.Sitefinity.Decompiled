...
// Type: Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormDropDownListAppearanceView
...
{
  public class FormDropDownListAppearanceView : ContentViewDesignerView
  {
    public static readonly string layoutTemplatePath = ControlUtilities.ToVppPath("Telerik.Sitefinity.Resources.Templates.Designers.Forms.FormDropDownListAppearanceView.ascx");
    internal const string designerViewJs = "Telerik.Sitefinity.Modules.Forms.Web.UI.Scripts.FormDropDownListAppearanceView.js";
    ...
    {
      get => string.IsNullOrEmpty(base.LayoutTemplatePath) ? FormDropDownListAppearanceView.layoutTemplatePath : base.LayoutTemplatePath;
    ...
    public override IEnumerable<ScriptReference> GetScriptReferences()
    {
      ...
      return (IEnumerable<ScriptReference>) new List<ScriptReference>()
      {
        ...
        new ScriptReference("Telerik.Sitefinity.Modules.Forms.Web.UI.Scripts.FormDropDownListAppearanceView.js", assembly)
      };
    }
  }
}
