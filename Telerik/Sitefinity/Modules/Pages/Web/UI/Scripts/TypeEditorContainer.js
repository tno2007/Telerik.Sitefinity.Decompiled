...
Telerik.Sitefinity.Modules.Pages.Web.UI.TypeEditorContainer=function(){this._cancelButtonId=null;
this._selectButtonId=null;
Telerik.Sitefinity.Modules.Pages.Web.UI.TypeEditorContainer.initializeBase(this);
};
Telerik.Sitefinity.Modules.Pages.Web.UI.TypeEditorContainer.prototype={initialize:function(){Telerik.Sitefinity.Modules.Pages.Web.UI.TypeEditorContainer.callBaseMethod(this,"initialize");
...
},dispose:function(){var cancelButton=$get(this._cancelButtonId);
...
},CancelCommand:function(){alert("Cancel");
},SelectCommand:function(){alert("Select");
},get_cancelButtonId:function(){return this._cancelButtonId;
},set_cancelButtonId:function(value){if(this._cancelButtonId!=value){this._cancelButtonId=value;
this.raisePropertyChanged("cancelButtonId");
}},get_selectButtonId:function(){return this._selectButtonId;
},set_selectButtonId:function(value){if(this._selectButtonId!=value){this._selectButtonId=value;
