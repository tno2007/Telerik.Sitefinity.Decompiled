TrackingConsentManager = (function () {
    ...
    return {
        ...
        init: function (dialogHtml) {
            if (!dialogHtml) {
                console.error("TrackingConsentManager is initialized with an empty value. This may mean that consent dialog file is missing or invalid. Please check server side logs for more details.");
            }
