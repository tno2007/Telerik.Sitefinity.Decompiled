...
// Type: Telerik.Sitefinity.Security.Data.RoleMetadataSource
...
{
  public class RoleMetadataSource : SecuredProviderMetadataSource
  {
    public RoleMetadataSource(IDatabaseMappingContext context)
      : base(context)
    {
    }
    ...
    protected override IList<IOpenAccessFluentMapping> BuildCustomMappings()
    {
      ...
      accessFluentMappingList.Add((IOpenAccessFluentMapping) new RoleFluentMapping(this.Context));
