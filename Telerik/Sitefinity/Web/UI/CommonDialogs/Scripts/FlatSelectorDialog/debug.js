...
Telerik.Sitefinity.Web.UI.CommonDialogs.FlatSelectorDialog = function (element) {
    Telerik.Sitefinity.Web.UI.CommonDialogs.FlatSelectorDialog.initializeBase(this, [element]);
...
Telerik.Sitefinity.Web.UI.CommonDialogs.FlatSelectorDialog.prototype = {
    initialize: function () {
    ...
    dispose: function () {
        Telerik.Sitefinity.Web.UI.CommonDialogs.FlatSelectorDialog.callBaseMethod(this, "dispose");
    },

    _doneClientSelection: function (sender, args) {
        var items = this.get_itemSelector().get_selectedItems();
        this.close(items)
    },

    _cancelClientsSelection: function (sender, args) {
        this.close(null);
    },
    ...
    _onLoadHandler: function (sender, args) {
        this.get_itemSelector().get_binder().add_onDataBound(this._binderDataBoundDelegate);
    ...
    set_intialSelectedItems: function (value) {
        this._intialSelectedItems = value;
        if (!this._isFirstBind) {
            this.get_itemSelector().get_binder().selectByIds(this._intialSelectedItems, false);
        }
    }
};
