...
// Type: Telerik.Sitefinity.Web.UI.Fields.Config.ContentWorkflowStatusInfoFieldElement
...
namespace Telerik.Sitefinity.Web.UI.Fields.Config
{
  ...
  /// </summary>
  public class ContentWorkflowStatusInfoFieldElement : 
    ...
    IDefinition
  {
    ...
    /// will not be thrown.
    /// </remarks>
    public ContentWorkflowStatusInfoFieldElement(ConfigElement parent)
      : base(parent)
    {
    }
    ...
    /// <returns></returns>
    public override DefinitionBase GetDefinition() => (DefinitionBase) new ContentWorkflowStatusInfoFieldDefinition((ConfigElement) this);
