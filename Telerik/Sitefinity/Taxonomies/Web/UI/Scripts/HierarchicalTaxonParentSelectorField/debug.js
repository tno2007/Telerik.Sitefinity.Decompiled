...
Telerik.Sitefinity.Taxonomies.Web.UI.HierarchicalTaxonParentSelectorField = function (element) {
...
Telerik.Sitefinity.Taxonomies.Web.UI.HierarchicalTaxonParentSelectorField.prototype =
{
    initialize: function () {
    ...
    _configureServiceUrls: function (taxonId) {
    ...
    set_dataItem: function (value) {
        ...
        else if (value.ParentTaxonId != null && value.ParentTaxonTitle != null) {
            parent =
            {
                Id: value.ParentTaxonId,
                Title: value.ParentTaxonTitle
            };
        }
    ...
    reset: function () {
        Telerik.Sitefinity.Taxonomies.Web.UI.HierarchicalTaxonParentSelectorField.callBaseMethod(this, "reset");
        this.clearSelection();
    },
    ...
    _changeSelectedNodeClick: function () {
        ...
        var context = null;
        if (typeof this._selectedNode != "undefined" && this._selectedNode != null && this._selectedNode.Id != $sitefinity.getEmptyGuid()) {
            context = this._selectedNode;
        }
    ...
    _selectorDataBoundHandler: function (sender, args) {
        if (this._dataItem && this._dataItem.ParentTaxonId) {
            var currentlySelectedNode = this._getSelectorNode(sender, this._dataItem.ParentTaxonId);
    ...
    _selectorItemDataBoundHandler: function (sender, args) {
        ...
        if (this._dataItem && dataItem.Id === this._dataItem.Id) {
    ...
    _handleNodesRootChoiceChanged: function (sender, args) {
        ...
        if (selectedNode) {
            this._setValueInternal(selectedNode);
        }
        else {
    ...
    set_uiCulture: function (culture) {
        Telerik.Sitefinity.Taxonomies.Web.UI.HierarchicalTaxonParentSelectorField.callBaseMethod(this, "set_uiCulture", [culture]);
