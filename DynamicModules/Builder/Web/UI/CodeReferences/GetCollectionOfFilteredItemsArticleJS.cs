...
// Type: Telerik.Sitefinity.DynamicModules.Builder.Web.UI.CodeReferences.GetCollectionOfFilteredItemsArticleJS
...
{
  public class GetCollectionOfFilteredItemsArticleJS : ClientSideCodeArticleBase
  {
    /// <summary>
    ...
    {
      return string.Format("Get a collection of {0} through Filtering", (object) this.PluralsNameResolver.ToPlural(this.ModuleType.DisplayName));
    }
    ...
    public override string GenerateArticleDescription(
      ...
      CultureInfo culture = null)
    {
      return this.ContextRegex.Replace("This is a description for retrieving a collection of !#TypeNamePlural#! through filtering. In order to retrieve !#TypeNamePlural#! through filtering, we will use the\r\n            <br/>Data.svc service and GET method. Basically will do the same as in the Get a collection of !#TypeNamePlural#! Article and will add filter expression.\r\n            <br/>Let's see a basic jQuery request example:", (MatchEvaluator) (m => this.ReplaceCodeSampleKey(m, moduleType, culture)));
    }
