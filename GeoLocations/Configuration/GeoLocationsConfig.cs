...
// Type: Telerik.Sitefinity.GeoLocations.Configuration.GeoLocationsConfig
...
using Telerik.Sitefinity.GeoLocations.Data;
using Telerik.Sitefinity.Web.Configuration;

namespace Telerik.Sitefinity.GeoLocations.Configuration
{
  public class GeoLocationsConfig : ConfigSection
  {
    ...
    protected override void OnPropertiesInitialized()
    {
      ...
      providers.Add(new DataProviderSettings((ConfigElement) providers)
      {
        ...
        ProviderType = typeof (OpenAccessGeoLocationsProvider)
      });
    }
  }
}
