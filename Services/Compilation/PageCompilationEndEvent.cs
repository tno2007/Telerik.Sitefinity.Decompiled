...
// Type: Telerik.Sitefinity.Services.Compilation.PageCompilationEndEvent
...
{
  /// <summary>
  /// This class describes a compilation end event for a <see cref="T:System.Web.UI.Page" />.
  /// </summary>
  /// <seealso cref="!:Telerik.Sitefinity.Services.IItemCompilationEndEvent" />
  internal class PageCompilationEndEvent : IPageCompilationEndEvent, IPageCompilationEvent, IEvent
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Services.Compilation.PageCompilationEndEvent" /> class.
    /// </summary>
    ...
    public PageCompilationEndEvent(
      Guid compilationId,
