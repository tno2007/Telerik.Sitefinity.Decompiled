...
// Type: Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormTextBoxLabelView
...
{
  public class FormTextBoxLabelView : FormMetaFieldLabelViewBase
  {
    public static readonly string layoutTemplatePath = ControlUtilities.ToVppPath("Telerik.Sitefinity.Resources.Templates.Designers.Forms.FormTextBoxLabelView.ascx");
    internal const string designerViewJs = "Telerik.Sitefinity.Modules.Forms.Web.UI.Scripts.FormTextBoxLabelView.js";
    ...
    {
      get => string.IsNullOrEmpty(base.LayoutTemplatePath) ? FormTextBoxLabelView.layoutTemplatePath : base.LayoutTemplatePath;
    ...
    /// <summary>
    /// Represents the choicefield for setting the is localizable option
    /// </summary>
    ...
    public override IEnumerable<ScriptReference> GetScriptReferences()
    {
      ...
      return (IEnumerable<ScriptReference>) new List<ScriptReference>()
      {
        ...
        new ScriptReference("Telerik.Sitefinity.Modules.Forms.Web.UI.Scripts.FormTextBoxLabelView.js", assembly)
      };
    }
  }
}
