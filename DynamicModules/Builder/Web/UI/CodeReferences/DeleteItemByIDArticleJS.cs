...
// Type: Telerik.Sitefinity.DynamicModules.Builder.Web.UI.CodeReferences.DeleteItemByIDArticleJS
...
{
  public class DeleteItemByIDArticleJS : ClientSideCodeArticleBase
  {
    /// <summary>
    ...
    {
      return string.Format("Delete {0} {1} by ID", (object) this.IndefiniteArticleNameResolver.Prefix, (object) this.ModuleType.DisplayName);
    }
