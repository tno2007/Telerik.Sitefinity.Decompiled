...
// Type: Telerik.Sitefinity.Fluent.ContentFluentApi.VideoTempFacade`1
...
{
  /// <summary>Manages the temp state of a video</summary>
  /// <typeparam name="TParentFacade">The type of the parent facade.</typeparam>
  public class VideoTempFacade<TParentFacade> : 
    MediaTempFacade<VideoTempFacade<TParentFacade>, TParentFacade, Video, VideoPublicFacade<TParentFacade>>,
    ISupportVersioning<VideoTempFacade<TParentFacade>>
  ...
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Fluent.ContentFluentApi.VideoTempFacade`1" /> class.
    /// </summary>
    ...
    public VideoTempFacade(AppSettings settings)
      : base(settings)
    {
    }
    ...
    /// <exception cref="T:System.ArgumentNullException">When <paramref name="settings" /> is null</exception>
    /// <exception cref="T:System.ArgumentException">When <paramref name="settings" />'s transaction name is null or empty</exception>
    public VideoTempFacade(AppSettings settings, TParentFacade parentFacade)
    ...
    public VideoTempFacade(AppSettings settings, TParentFacade parentFacade, Guid itemID)
    ...
    /// <exception cref="T:System.ArgumentException">When <paramref name="settings" />'s transaction name is null or empty</exception>
    public VideoTempFacade(AppSettings settings, TParentFacade parentFacade, Video item)
    ...
    public virtual VersioningFacade<VideoTempFacade<TParentFacade>> Versioning() => new VersioningFacade<VideoTempFacade<TParentFacade>>(this.settings, this, (IDataItem) this.Get());
  }
}
