...
// Type: Telerik.Sitefinity.Taxonomies.ScheduledTasks.DummyTaxonomyMultisiteTaskService
...
{
  /// <summary>
  /// A dummy service implementation for managing multisite taxonomy <see cref="!:ScheduledTask" /> objects
  /// used for managing item to taxon relations in multisite context (split, sync of taxonomies)
  /// </summary>
  public class DummyTaxonomyMultisiteTaskService : ITaxonomyMultisiteTaskService
  {
    /// <summary>
    ...
    /// <returns>The Id of the newly created schedule task.</returns>
    public virtual Guid CreateTaxonomyUnlinkFromSiteCleanTask(Guid siteId, ITaxonomy taxonomy) => Guid.Empty;
  }
}
