...
// Type: Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.FormMultipleChoiceFieldDesigner
...
{
  public class FormMultipleChoiceFieldDesigner : ContentViewDesignerBase
  {
    /// <inheritdoc />
    ...
    protected override void AddViews(Dictionary<string, ControlDesignerView> views)
    {
      ...
      FormChoiceFieldColumnsAppearanceView columnsAppearanceView = new FormChoiceFieldColumnsAppearanceView();
      views.Add(columnsAppearanceView.ViewName, (ControlDesignerView) columnsAppearanceView);
    }
  }
}
