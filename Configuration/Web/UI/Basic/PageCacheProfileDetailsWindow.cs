...
// Type: Telerik.Sitefinity.Configuration.Web.UI.Basic.PageCacheProfileDetailsWindow
...
{
  /// <summary>
  /// A control managing a client window for creating and updating page cache profiles.
  /// </summary>
  /// <seealso cref="T:Telerik.Sitefinity.Web.UI.SimpleScriptView" />
  public class PageCacheProfileDetailsWindow : CacheProfileDetailsWindow
  {
    private static readonly string LayoutTemplateVirtualPath = ControlUtilities.ToVppPath("Telerik.Sitefinity.Resources.Templates.Backend.Configuration.Basic.PageCacheProfileDetailsWindow.ascx");

    /// <summary>Gets the layout template path.</summary>
    public override string LayoutTemplatePath
    {
      get => string.IsNullOrEmpty(base.LayoutTemplatePath) ? PageCacheProfileDetailsWindow.LayoutTemplateVirtualPath : base.LayoutTemplatePath;
      set => base.LayoutTemplatePath = value;
    }

    /// <summary>Gets the new profile.</summary>
    /// <value>The new profile.</value>
    internal override CacheProfileViewModel NewProfile => new CacheProfileViewModel(new OutputCacheProfileElement((ConfigElement) Config.Get<SystemConfig>().CacheSettings.Profiles), CacheProfileViewModel.PageCacheItemTypes);
    ...
    protected override string ServiceUrl => this.ResolveClientUrl("~/Sitefinity/Services/CacheProfiles/Settings.svc/page");
  }
}
