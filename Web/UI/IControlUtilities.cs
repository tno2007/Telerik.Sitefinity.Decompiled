...
// Type: Telerik.Sitefinity.Web.UI.IControlUtilities
...
{
  /// <summary>
  /// An interface which is implemented by the control (UI control) utilities class.
  /// </summary>
  public interface IControlUtilities
  {
    /// <summary>
    ...
    string ToVppPath(string layoutTemplateName);
  }
}
