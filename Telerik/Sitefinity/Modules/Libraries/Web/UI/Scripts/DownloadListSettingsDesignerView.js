...
Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.ViewNames.prototype={MasterListView:0,MasterTableView:1,MasterListDetailView:2,MasterTableDetailView:3};
...
Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.DownloadListSettingsDesignerView=function(element){Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.DownloadListSettingsDesignerView.initializeBase(this,[element]);
...
Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.DownloadListSettingsDesignerView.prototype={initialize:function(){Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.DownloadListSettingsDesignerView.callBaseMethod(this,"initialize");
...
if(this._editListTemplateDelegate==null){this._editListTemplateDelegate=Function.createDelegate(this,this._editListTemplateClicked);
}if(this._editTableTemplateDelegate==null){this._editTableTemplateDelegate=Function.createDelegate(this,this._editTableTemplateClicked);
}if(this._editListDetailTemplateDelegate==null){this._editListDetailTemplateDelegate=Function.createDelegate(this,this._editListDetailTemplateClicked);
}if(this._editTableDetailTemplateDelegate==null){this._editTableDetailTemplateDelegate=Function.createDelegate(this,this._editTableDetailTemplateClicked);
}if(this._editDetailTemplateDelegate==null){this._editDetailTemplateDelegate=Function.createDelegate(this,this._editDetailTemplateClicked);
}if(this._editDetailTemplateLink2Delegate==null){this._editDetailTemplateLink2Delegate=Function.createDelegate(this,this._editDetailTemplateLink2Clicked);
...
},dispose:function(){Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.DownloadListSettingsDesignerView.callBaseMethod(this,"dispose");
Sys.Application.remove_load(this._pageLoadDelegate);
for(var i=0,length=this._modeRadioButtonClientIDs.length;
i<length;
i++){var radio=$get(this._modeRadioButtonClientIDs[i]);
...
if(this._editListTemplateDelegate){delete this._editListTemplateDelegate;
}if(this._editTableTemplateDelegate){delete this._editTableTemplateDelegate;
}if(this._editListDetailTemplateDelegate){delete this._editListDetailTemplateDelegate;
}if(this._editTableDetailTemplateDelegate){delete this._editTableDetailTemplateDelegate;
}if(this._editDetailTemplateDelegate){delete this._editDetailTemplateDelegate;
}if(this._editDetailTemplateLink2Delegate){delete this._editDetailTemplateLink2Delegate;
...
}else{var noPagingRadio=$get(this._noLimitAndPagingRadioButtonsClientIDs[newMode]);
$(noPagingRadio).click();
}}},_modeRadioButtonCheckedChanged:function(sender,args){var clickedRadioID=sender.target.value;
switch(clickedRadioID){case"rbMode1":this._currentMode=$views.MasterListView;
this._refreshThumbnailType(this._currentMode);
break;
case"rbMode2":this._currentMode=$views.MasterTableView;
this._refreshThumbnailType(this._currentMode);
break;
case"rbMode3":this._currentMode=$views.MasterListDetailView;
this._refreshDownloadLinkPosition(this._currentMode);
break;
case"rbMode4":this._currentMode=$views.MasterTableDetailView;
this._refreshThumbnailType(this._currentMode);
this._refreshDownloadLinkPosition(this._currentMode);
break;
default:this._currentMode=$views.MasterListView;
break;
...
}},_editListTemplateClicked:function(sender,args){this._selectedMasterTemplateId=this._templateLinkIdMap[this.get_editListTemplateLink().id];
this._selectedDetailTemplateId=null;
this._showWidgetEditor();
},_editTableTemplateClicked:function(sender,args){this._selectedMasterTemplateId=this._templateLinkIdMap[this.get_editTableTemplateLink().id];
this._selectedDetailTemplateId=null;
this._showWidgetEditor();
},_editListDetailTemplateClicked:function(sender,args){this._selectedMasterTemplateId=this._templateLinkIdMap[this.get_editListDetailTemplateLink().id];
this._selectedDetailTemplateId=null;
this._showWidgetEditor();
},_editTableDetailTemplateClicked:function(sender,args){this._selectedMasterTemplateId=this._templateLinkIdMap[this.get_editTableDetailTemplateLink().id];
this._selectedDetailTemplateId=null;
this._showWidgetEditor();
},_editDetailTemplateClicked:function(sender,args){this._selectedDetailTemplateId=this._templateLinkIdMap[this.get_editDetailTemplateLink().id];
this._selectedMasterTemplateId=null;
this._showWidgetEditor();
},_editDetailTemplateLink2Clicked:function(sender,args){this._selectedDetailTemplateId=this._templateLinkIdMap[this.get_editDetailTemplateLink2().id];
this._selectedMasterTemplateId=null;
this._showWidgetEditor();
...
},_displayPagingForMode:function(mode,itemsPerPage){var pagingRadio=$get(this._pagingRadioButtonClientIDs[mode]);
$(pagingRadio).click();
...
return propertyPath;
},_setPagingOrLimitToControlData:function(mode){var currentModePagingRadio=$get(this._pagingRadioButtonClientIDs[mode]);
var parentDesigner=this.get_parentDesigner();
var textField=null;
if(currentModePagingRadio.checked){parentDesigner.setValueToControlData(this._resolvePropertyPath("AllowPaging"),true,this.get_controlData());
...
}}},_setDownloadLinkPosition:function(mode){var choiceField=null;
switch(mode){case $views.MasterListDetailView:choiceField=$find(this._downloadLinkPositionChoiceFieldIDs[0]);
break;
case $views.MasterTableDetailView:choiceField=$find(this._downloadLinkPositionChoiceFieldIDs[1]);
break;
...
},_setThumbnailType:function(mode){var thumbnailType;
switch(mode){case $views.MasterListView:for(var i=0,length=this._iconSizesRadioButtonsClientIDs.length;
i<length;
...
case $views.MasterTableView:var displayIconsCheckBox=$get(this._displayIconsCheckBoxIDs[0]);
if(jQuery(displayIconsCheckBox).is(":checked")){thumbnailType="SmallIcons";
}else{thumbnailType="NoIcons";
}break;
case $views.MasterTableDetailView:var displayIconsCheckBox=$get(this._displayIconsCheckBoxIDs[1]);
if(jQuery(displayIconsCheckBox).is(":checked")){thumbnailType="SmallIcons";
}else{thumbnailType="NoIcons";
}break;
}if(thumbnailType){var parent=this.get_parentDesigner();
parent.setValueToControlData(this._resolvePropertyPath("ThumbnailType"),thumbnailType,this.get_controlData());
}},_refreshDownloadLinkPosition:function(mode){this._currentViewName=this._masterViewNameMap[mode];
var currentView=this.get_currentView();
var choiceField;
switch(mode){case $views.MasterListDetailView:choiceField=$find(this._downloadLinkPositionChoiceFieldIDs[0]);
break;
...
if(currentView.ShowDownloadLinkBelowDescription){choiceValues.push("below");
}if(currentView.ShowDownloadLinkAboveDescription){choiceValues.push("above");
}if(choiceValues.length>0){choiceField.set_value(choiceValues);
}},_refreshThumbnailType:function(mode){this._currentViewName=this._masterViewNameMap[mode];
var currentView=this.get_currentView();
switch(mode){case $views.MasterListView:switch(currentView.ThumbnailType){case"NoIcons":jQuery(this._noIconsRadioButton).attr("checked",true);
break;
...
case $views.MasterTableView:var displayIconsCheckBox=$get(this._displayIconsCheckBoxIDs[0]);
if(currentView.ThumbnailType!="NoIcons"&&currentView.ThumbnailType!="NoSet"){jQuery(displayIconsCheckBox).attr("checked",true);
}else{jQuery(displayIconsCheckBox).attr("checked",false);
}break;
case $views.MasterListDetailView:break;
case $views.MasterTableDetailView:var displayIconsCheckBox=$get(this._displayIconsCheckBoxIDs[1]);
if(currentView.ThumbnailType!="NoIcons"&&currentView.ThumbnailType!="NoSet"){jQuery(displayIconsCheckBox).attr("checked",true);
}else{jQuery(displayIconsCheckBox).attr("checked",false);
}break;
...
var currentView=this.get_currentView();
switch(currentView.ViewName){case this._masterViewNameMap[$views.MasterListView]:this._currentMode=$views.MasterListView;
this._refreshThumbnailType(this._currentMode);
break;
case this._masterViewNameMap[$views.MasterTableView]:this._currentMode=$views.MasterTableView;
this._refreshThumbnailType(this._currentMode);
break;
case this._masterViewNameMap[$views.MasterListDetailView]:this._currentMode=$views.MasterListDetailView;
this._refreshDownloadLinkPosition(this._currentMode);
break;
case this._masterViewNameMap[$views.MasterTableDetailView]:this._currentMode=$views.MasterTableDetailView;
this._refreshThumbnailType(this._currentMode);
this._refreshDownloadLinkPosition(this._currentMode);
break;
default:this._currentMode=$views.MasterListView;
...
}},get_editListTemplateLink:function(){return this._editListTemplateLink;
},set_editListTemplateLink:function(value){if(this._editListTemplateLink!=value){this._editListTemplateLink=value;
}},get_editTableTemplateLink:function(){return this._editTableTemplateLink;
},set_editTableTemplateLink:function(value){if(this._editTableTemplateLink!=value){this._editTableTemplateLink=value;
}},get_editListDetailTemplateLink:function(){return this._editListDetailTemplateLink;
},set_editListDetailTemplateLink:function(value){if(this._editListDetailTemplateLink!=value){this._editListDetailTemplateLink=value;
}},get_editTableDetailTemplateLink:function(){return this._editTableDetailTemplateLink;
},set_editTableDetailTemplateLink:function(value){if(this._editTableDetailTemplateLink!=value){this._editTableDetailTemplateLink=value;
...
}},get_editDetailTemplateLink2:function(){return this._editDetailTemplateLink2;
},set_editDetailTemplateLink2:function(value){if(this._editDetailTemplateLink2!=value){this._editDetailTemplateLink2=value;
