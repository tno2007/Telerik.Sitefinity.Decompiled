...
var urlShortDialog;
Telerik.Sitefinity.Publishing.Twitter.TwitterUrlShortConfigDialog=function(element){Telerik.Sitefinity.Publishing.Twitter.TwitterUrlShortConfigDialog.initializeBase(this,[element]);
this._acc={};
...
Telerik.Sitefinity.Publishing.Twitter.TwitterUrlShortConfigDialog.prototype={initialize:function(){urlShortDialog=this;
...
},intializeDialog:function(dataItem){this._acc.AccountName=dataItem.AccountName;
...
}}},dispose:function(){$(this._saveButton).unbind("click",this._saveClientSelectionDelegate);
this._saveClientSelectionDelegate=null;
...
},set_acc:function(value){this._acc=value;
},get_acc:function(){return this._acc;
