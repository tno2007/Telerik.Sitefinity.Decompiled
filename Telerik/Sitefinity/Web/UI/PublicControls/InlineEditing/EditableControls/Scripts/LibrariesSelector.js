define(["HierarchicalContentSelector"],function(HierarchicalContentSelector){function LibrariesSelector(parentElement){var that=this;
HierarchicalContentSelector.call(this,parentElement);
this.serviceUrl="Sitefinity/Services/Content/AlbumService.svc/folders/";
return(this);
}LibrariesSelector.prototype={resolveUrlFunc:function(options){if(options.Id){return String.format("{0}/{1}/",this.getServiceUrl(),options.Id);
}return this.getServiceUrl();
},parameterMapFunc:function(options){var that=this;
var queryObj={sortExpression:"Title ASC",provider:this.providerName};
