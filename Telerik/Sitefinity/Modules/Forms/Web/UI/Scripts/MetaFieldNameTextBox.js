...
Telerik.Sitefinity.Modules.Forms.Web.UI.Fields.MetaFieldNameTextBox=function(element){Telerik.Sitefinity.Modules.Forms.Web.UI.Fields.MetaFieldNameTextBox.initializeBase(this,[element]);
...
Telerik.Sitefinity.Modules.Forms.Web.UI.Fields.MetaFieldNameTextBox.prototype={initialize:function(){Telerik.Sitefinity.Modules.Forms.Web.UI.Fields.MetaFieldNameTextBox.callBaseMethod(this,"initialize");
this.get_metaFieldNameTextField().set_value(this._fieldName);
if(!this._readOnly){this._changeButtonClickDelegate=Function.createDelegate(this,this._changeButtonClickHandler);
...
},dispose:function(){Telerik.Sitefinity.Modules.Forms.Web.UI.Fields.MetaFieldNameTextBox.callBaseMethod(this,"dispose");
if(this._metaFieldNameBlurDelegate){delete this._metaFieldNameBlurDelegate;
}if(this._changeButtonClickDelegate){delete this._changeButtonClickDelegate;
}if(this._expandButtonClickDelegate){delete this._expandButtonClickDelegate;
}},_changeButtonClickHandler:function(e){this._metaFieldNameTextField.set_displayMode(Telerik.Sitefinity.Web.UI.Fields.FieldDisplayMode.Write);
jQuery(this._changeButton).hide();
if(!this._blurInitialized){$addHandler(this.get_metaFieldNameTextField().get_textElement(),"blur",this._metaFieldNameBlurDelegate,true);
}this._isEditModeEntered=true;
},_metaFieldNameBlurHandler:function(e){this._metaFieldNameTextField.set_displayMode(Telerik.Sitefinity.Web.UI.Fields.FieldDisplayMode.Read);
jQuery(this._changeButton).show();
},_expandButtonClickHandler:function(e){jQuery(this._expandableSection).toggleClass("sfExpandedSection");
dialogBase.resizeToContent();
},get_value:function(){var val;
if(this._isEditModeEntered){val=this._metaFieldNameTextField._get_writeModeValue();
if(typeof val==="string"&&val.length>0){return val;
}}return this._metaFieldNameTextField.get_value();
},set_value:function(value){this._metaFieldNameTextField.set_value(value);
