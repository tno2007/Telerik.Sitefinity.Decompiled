...
// Type: Telerik.Sitefinity.Web.UI.Fields.Definitions.ContentStatisticsFieldDefinition
...
namespace Telerik.Sitefinity.Web.UI.Fields.Definitions
{
  ...
  /// </summary>
  public class ContentStatisticsFieldDefinition : 
    ...
    IDefinition
  {
    ...
    /// </summary>
    public ContentStatisticsFieldDefinition()
    {
    }
    ...
    public ContentStatisticsFieldDefinition(ConfigElement configDefinition)
