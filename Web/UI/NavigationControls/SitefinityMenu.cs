...
// Type: Telerik.Sitefinity.Web.UI.NavigationControls.SiteMenu
...
{
  /// <summary>
  /// Wrapper around the Telerik's <see cref="T:Telerik.Web.UI.RadMenu" /> control which provides Sitefinity
  /// specific navigational menu control.
  /// </summary>
  public class SiteMenu : RadMenu
  {
