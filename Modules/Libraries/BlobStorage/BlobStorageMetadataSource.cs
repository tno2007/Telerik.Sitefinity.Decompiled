...
// Type: Telerik.Sitefinity.Modules.Libraries.BlobStorage.BlobStorageMetadataSource
...
namespace Telerik.Sitefinity.Modules.Libraries.BlobStorage
{
  ...
  /// </summary>
  public class BlobStorageMetadataSource : SitefinityMetadataSourceBase
  {
    public BlobStorageMetadataSource(IDatabaseMappingContext context)
      : base(context)
    {
    }
    ...
    {
      (IOpenAccessFluentMapping) new BlobStorageFluentMapping(this.Context)
    };
  }
}
