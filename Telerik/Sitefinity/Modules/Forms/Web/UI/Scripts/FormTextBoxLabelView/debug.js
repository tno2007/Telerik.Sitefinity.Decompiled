...
Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormTextBoxLabelView = function (element) {
    Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormTextBoxLabelView.initializeBase(this, [element]);
...
Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormTextBoxLabelView.prototype = {
    /* --------------------------------- set up and tear down --------------------------------- */
    initialize: function () {
        Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormTextBoxLabelView.callBaseMethod(this, 'initialize');
    ...
    dispose: function () {
        Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormTextBoxLabelView.callBaseMethod(this, 'dispose');
    ...
    /* --------------------------------- private methods --------------------------------- */
    _validate: function () {
        var limitationsView = this._getFormTextBoxLimitationsView();
    ...
    _getFormTextBoxLimitationsView: function () {
        var parent = this.get_propertyEditor().get_designer();
        if (parent) {
            var formTextBoxLimitationsViewId = parent.get_designerViewsMap()["FormTextBoxLimitationsView"];

            var formTextBoxLimitationsView = $find(formTextBoxLimitationsViewId);
            return formTextBoxLimitationsView;
        }
        return null;
    },
    /* --------------------------------- properties --------------------------------- */
...
Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormTextBoxLabelView.registerClass('Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormTextBoxLabelView', Sys.UI.Control, Telerik.Sitefinity.Web.UI.ControlDesign.IDesignerViewControl);
