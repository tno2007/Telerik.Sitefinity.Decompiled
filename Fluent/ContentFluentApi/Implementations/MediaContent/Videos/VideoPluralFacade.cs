...
// Type: Telerik.Sitefinity.Fluent.ContentFluentApi.VideoPluralFacade`1
...
{
  /// <summary>Manage a collection of videos</summary>
  /// <typeparam name="TParentFacade">Type of the parent facade</typeparam>
  public class VideoPluralFacade<TParentFacade> : 
    BaseContentPluralFacadeWithLifeCycle<VideoPluralFacade<TParentFacade>, VideoDraftFacade<VideoPluralFacade<TParentFacade>>, TParentFacade, Video>
    where TParentFacade : BaseFacade
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Fluent.ContentFluentApi.VideoPluralFacade`1" /> class.
    /// </summary>
    ...
    public VideoPluralFacade(AppSettings settings)
      : base(settings)
    {
    }
    ...
    /// <exception cref="!:ArgumentNullException">When <paramref name="settings" /> is null</exception>
    /// <exception cref="!:ArgumentException">When <paramref name="settings" />'s transaction name is null or empty</exception>
    public VideoPluralFacade(AppSettings settings, TParentFacade parentFacade)
