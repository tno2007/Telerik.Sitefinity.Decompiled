...
Telerik.Sitefinity.Web.UI.Fields.BlockableIpField=function(element){Telerik.Sitefinity.Web.UI.Fields.BlockableIpField.initializeBase(this,[element]);
...
Telerik.Sitefinity.Web.UI.Fields.BlockableIpField.prototype={initialize:function(){Telerik.Sitefinity.Web.UI.Fields.BlockableIpField.callBaseMethod(this,"initialize");
...
},dispose:function(){Telerik.Sitefinity.Web.UI.Fields.BlockableIpField.callBaseMethod(this,"dispose");
if(this._blockIpDelegate){delete this._blockIpDelegate;
}if(this._unblockIpDelegate){delete this._unblockIpDelegate;
}if(this._onLoadDelegate){Sys.Application.remove_load(this._onLoadDelegate);
delete this._onLoadDelegate;
}},_onLoad:function(){},blockIp:function(){this._blockIp_Success();
},unblockIp:function(){this._unblockIp_Success();
},_blockIp_Success:function(result){jQuery(this._blockIpLink).hide();
...
},_unblockIp_Success:function(result){jQuery(this._blockIpLink).show();
jQuery(this._unblockIpLink).hide();
jQuery(this._ipTextField).removeClass("sfBlocked").find(".sfTxtContent .sfBlockLbl").remove();
},get_ipTextField:function(){return this._ipTextField;
},set_ipTextField:function(value){this._ipTextField=value;
},get_blockIpLink:function(){return this._blockIpLink;
},set_blockIpLink:function(value){this._blockIpLink=value;
},get_unblockIpLink:function(){return this._unblockIpLink;
},set_unblockIpLink:function(value){this._unblockIpLink=value;
