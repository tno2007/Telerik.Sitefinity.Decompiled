...
// Type: Telerik.Sitefinity.Web.UI.PublicControls.Designers.CssEmbedControlDesigner
...
namespace Telerik.Sitefinity.Web.UI.PublicControls.Designers
{
  ...
  /// 
  /// </summary>
  public class CssEmbedControlDesigner : ContentViewDesignerBase
  {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Web.UI.PublicControls.Designers.CssEmbedControlDesigner" /> class.
    /// </summary>
    public CssEmbedControlDesigner() => this.LayoutTemplatePath = CssEmbedControlDesigner.layoutTemplatePath;
    ...
    {
      CssFileEmbedDesignerView embedDesignerView = new CssFileEmbedDesignerView();
      views.Add(embedDesignerView.ViewName, (ControlDesignerView) embedDesignerView);
      CssEditorDesignerView editorDesignerView = new CssEditorDesignerView();
    ...
    /// <summary>Sets the advanced mode of property editor.</summary>
