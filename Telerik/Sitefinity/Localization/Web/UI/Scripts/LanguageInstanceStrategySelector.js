...
Telerik.Sitefinity.Localization.Web.UI.LanguageInstanceStrategySelector=function(element){this._wrapper=null;
this._loading=null;
...
Telerik.Sitefinity.Localization.Web.UI.LanguageInstanceStrategySelector.prototype={initialize:function(){Telerik.Sitefinity.Localization.Web.UI.LanguageInstanceStrategySelector.callBaseMethod(this,"initialize");
...
},dispose:function(){Telerik.Sitefinity.Localization.Web.UI.LanguageInstanceStrategySelector.callBaseMethod(this,"dispose");
...
}if(this._sourceDialogCommandDelegate){this.get_chooseSourceDialog().remove_command(this._sourceDialogCommandDelegate);
delete this._sourceDialogCommandDelegate;
}},_handlePageLoad:function(sender,args){},_localizationModeSuccess:function(caller,data,request,context){if(zoneEditorShared){zoneEditorShared.set_isPageRefreshControlled(true);
}var lang=context.Language;
var url=this.get_baseEditUrl()+"/"+lang;
location.href=url;
},_localizationModeFailure:function(error,caller,context){alert(error.Detail);
},_sourceDialogCommand:function(sender,args){var command=args.get_commandName();
if(command=="ok"){if(this.get_isInSplitMode()==true){var selectedLanguage=this.get_sourceLanguageCombo().get_value();
this._copyPageNodeData(selectedLanguage);
}else{var choice=this.get_syncedCheckbox().get_value();
var localizationMode=(choice=="true")?this.LM_SYNCED:this.LM_SPLIT;
this._persistChoiceAndReload(localizationMode,true);
}}else{}},_copyFromOtherButtonClicked:function(e){this.get_chooseSourceDialog().show_prompt();
},_startFromScratchButtonClicked:function(e){if(this.get_isInSplitMode()==true){this._copyPageNodeData("none");
}else{this._persistChoiceAndReload(this.LM_SPLIT,false);
}},_persistChoiceAndReload:function(localizationMode,copyData){jQuery(this.get_wrapper()).hide();
...
},_copyPageNodeData:function(sourceLanguage){var url=this.get_serviceUrl();
if(url.charAt(url.length-1)!="/"){url+="/";
...
},set_baseEditUrl:function(value){this._baseEditUrl=value;
...
},set_isInSplitMode:function(value){this._isInSplitMode=value;
...
},get_sourceLanguageCombo:function(){return this._sourceLanguageCombo;
},set_sourceLanguageCombo:function(value){this._sourceLanguageCombo=value;
},get_syncedCheckbox:function(){return this._syncedCheckbox;
},set_syncedCheckbox:function(value){this._syncedCheckbox=value;
},get_chooseSourceDialog:function(){return this._chooseSourceDialog;
},set_chooseSourceDialog:function(value){this._chooseSourceDialog=value;
},get_radWindow:function(){return this._radWindow;
},set_radWindow:function(value){this._radWindow=value;
},get_copyFromOtherElement:function(){return this._copyFromOtherElement;
},set_copyFromOtherElement:function(value){this._copyFromOtherElement=value;
},get_startFromScratchElement:function(){return this._startFromScratchElement;
},set_startFromScratchElement:function(value){this._startFromScratchElement=value;
},get_wrapper:function(){return this._wrapper;
},set_wrapper:function(value){this._wrapper=value;
},get_loading:function(){return this._loading;
},set_loading:function(value){this._loading=value;
}};
