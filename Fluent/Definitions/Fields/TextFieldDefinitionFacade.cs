...
// Type: Telerik.Sitefinity.Fluent.Definitions.Fields.TextFieldDefinitionFacade`1
...
{
  /// <summary>
  /// Fluent API facade that defines a definition for text field element.
  /// </summary>
  /// <typeparam name="TParentFacade">The type of the parent facade.</typeparam>
  public class TextFieldDefinitionFacade<TParentFacade> : 
    BaseTextFieldDefinitionFacade<TextFieldDefinitionElement, TextFieldDefinitionFacade<TParentFacade>, TParentFacade>
    where TParentFacade : class
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Fluent.Definitions.Fields.TextFieldDefinitionFacade`1" /> class.
    /// </summary>
    ...
    public TextFieldDefinitionFacade(
      string moduleName,
    ...
    {
      this.Field.FieldType = typeof (TextField);
    }
    ...
    protected override TextFieldDefinitionElement CreateConfig(
      ConfigElementDictionary<string, FieldDefinitionElement> parentElement)
    {
      return new TextFieldDefinitionElement((ConfigElement) parentElement);
    }

    /// <summary>Sets the css class of the field control.</summary>
    /// <param name="cssClass">The css class.</param>
    /// <returns>Current facade for further customization</returns>
    public override TextFieldDefinitionFacade<TParentFacade> LocalizeUsing<TResourceClass>() => base.LocalizeUsing<TResourceClass>();
  }
}
