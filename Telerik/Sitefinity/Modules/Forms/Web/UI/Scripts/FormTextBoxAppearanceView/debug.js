...
Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormTextBoxAppearanceView = function (element) {
    Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormTextBoxAppearanceView.initializeBase(this, [element]);
    this._textBoxSizeChoiceField = null;
    this._cssClassTextField = null;
}

Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormTextBoxAppearanceView.prototype = {
    /* --------------------------------- set up and tear down --------------------------------- */
    initialize: function () {
        Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormTextBoxAppearanceView.callBaseMethod(this, 'initialize');
    },

    dispose: function () {
        Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormTextBoxAppearanceView.callBaseMethod(this, 'dispose');
    },
...
Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormTextBoxAppearanceView.registerClass('Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormTextBoxAppearanceView', Sys.UI.Control, Telerik.Sitefinity.Web.UI.ControlDesign.IDesignerViewControl);
