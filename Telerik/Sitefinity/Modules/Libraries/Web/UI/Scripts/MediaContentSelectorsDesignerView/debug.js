...
Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.MediaContentSelectorsDesignerView = function (element) {
    Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.MediaContentSelectorsDesignerView.initializeBase(this, [element]);
...
Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.MediaContentSelectorsDesignerView.prototype = {

    initialize: function () {
        Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.MediaContentSelectorsDesignerView.callBaseMethod(this, "initialize");
    ...
    dispose: function () {
        Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.MediaContentSelectorsDesignerView.callBaseMethod(this, "dispose");
        if (this._radioClickedDelegate) {
            $removeHandler(this._libraryRadio, 'click', this._radioClickedDelegate);
        ...
        if (this._openLibrarySelectorDelegate) {
            $removeHandler(this._selectLibraryButton, 'click', this._openLibrarySelectorDelegate);
        ...
        if (this._openUploadDialogDelegate) {
            delete this._openUploadDialogDelegate;
        }
        ...
        if (selectedItems != null) {
            if (selectedItems.length > 0) {
                ...
                if (selectedTitle.hasOwnProperty('Value')) {
                    this.get_selectedLibrary().innerText = selectedTitle.Value;
                } else {
                    this.get_selectedLibrary().innerText = selectedTitle;
                }
    ...
    _radioClicked: function (sender, args) {
        switch (sender.target) {
            case this._libraryRadio:
                ...
                break;
            case this._allItemsRadio:
                $("#selectLibraryWrapper").hide();
                $("#uploadWrapper").hide();
                break;
    ...
    _getCurrentView: function (parent) {
        var settingsDesignerViewId = parent.get_designerViewsMap()["imageGallerySettingsDesignerView"];
        if (!settingsDesignerViewId) {
            settingsDesignerViewId = parent.get_designerViewsMap()["videoGallerySettingsDesignerView"];
        }
    ...
    refreshUI: function () {
        ...
        if (this.get_sortingField()._get_listItemByValue(currentView.SortExpression).length == 0) {
            this.get_sortingField().set_value("custom");
        }
        else {
            this.get_sortingField().set_value(currentView.SortExpression);
        }
    ...
    get_allItemsRadio: function () {
        return this._allItemsRadio;
    },

    set_allItemsRadio: function (value) {
        if (this._allItemsRadio != value) {
            this._allItemsRadio = value;
            this.raisePropertyChanged("allItemsRadio");
        }
    },

    get_libraryRadio: function () {
        return this._libraryRadio;
    },

    set_libraryRadio: function (value) {
        if (this._libraryRadio != value) {
            this._libraryRadio = value;
            this.raisePropertyChanged("libraryRadio");
        }
    },

    get_uploadRadio: function () {
        return this._uploadRadio;
    },

    set_uploadRadio: function (value) {
        if (this._uploadRadio != value) {
            this._uploadRadio = value;
            this.raisePropertyChanged("uploadRadio");
        }
    },

    get_sortingField: function () {
        return this._sortingField;
    },

    set_sortingField: function (value) {
