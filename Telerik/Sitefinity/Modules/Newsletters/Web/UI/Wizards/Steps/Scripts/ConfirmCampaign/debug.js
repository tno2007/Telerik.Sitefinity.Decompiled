...
Telerik.Sitefinity.Modules.Newsletters.Web.UI.Wizards.Steps.ConfirmCampaign = function (element) {
    this._saveCampaignButton = null;
...
Telerik.Sitefinity.Modules.Newsletters.Web.UI.Wizards.Steps.ConfirmCampaign.prototype = {

    // set up 
    initialize: function () {

        if (this._saveCampaignDelegate === null) {
            this._saveCampaignDelegate = Function.createDelegate(this, this._saveCampaignHandler);
        }

        if (this._previewCampaignDelegate === null) {
            this._previewCampaignDelegate = Function.createDelegate(this, this._previewCampaignHandler);
        }

        if (this._sendTestDelegate === null) {
            this._sendTestDelegate = Function.createDelegate(this, this._sendTestHandler);
        }

        if (this._sendDelegate === null) {
            this._sendDelegate = Function.createDelegate(this, this._sendHandler);
        }

        if (this._sendTestCallbackDelegate === null) {
            this._sendTestCallbackDelegate = Function.createDelegate(this, this._sendTestCallback);
        }

        if (this._scheduleDeliveryDelegate === null) {
            this._scheduleDeliveryDelegate = Function.createDelegate(this, this._scheduleDeliveryHandler);
        }

        if (this._discardCampaignDelegate === null) {
            this._discardCampaignDelegate = Function.createDelegate(this, this._discardCampaignHandler);
        }
    ...
    // tear down
    dispose: function () {
        if (this._saveCampaignDelegate) {
            delete this._saveCampaignDelegate;
        }
        if (this._previewCampaignDelegate) {
            delete this._previewCampaignDelegate;
        }
        ...
        if (this._scheduleDeliveryDelegate) {
            delete this._scheduleDeliveryDelegate;
        }
        if (this._discardCampaignDelegate) {
            delete this._discardCampaignDelegate;
        }
    ...
    _commandHandler: function (commandName, commandArgument) {
    ...
    _saveCampaignHandler: function (sender, args) {
        this._commandHandler('saveCampaign');
    },

    _previewCampaignHandler: function (sender, args) {
        this._commandHandler('previewCampaign');
    },

    _sendTestHandler: function (sender, args) {
    ...
    _sendTestCallback: function (sender, args) {
        if (args.get_commandName() == "send") {
            this._commandHandler('sendTest', sender.get_inputText());
        }
    },

    _sendHandler: function (sender, args) {
        this._commandHandler('send');
    },

    _scheduleDeliveryHandler: function (sender, args) {
        this._scheduleCampaignDialog.add_pageLoad(Function.createDelegate(this, this._onScheduleCampaignDialogLoaded));
    ...
    _onScheduleCampaignDialogLoaded: function (sender, args) {
        scheduleCampaignDialog.remove_pageLoad(onScheduleCampaignDialogLoaded);
        scheduleCampaignDialog.add_show(Function.createDelegate(this, this._scheduleCampaignDialogShowed));
    },

    _scheduleCampaignDialogShowed: function (sender, args)
    {
        this._scheduleCampaignDialog.get_contentFrame().contentWindow.reset();    
    },

    _scheduleCampaignDialogCloses: function (sender, args) {
        this._commandHandler('scheduleDelivery', args.get_argument());
    },

    _discardCampaignHandler: function (sender, args) {
        this._commandHandler('discardCampaign');
    },

    /* *************************** properties *************************** */
    get_saveCampaignButton: function () {
        return this._saveCampaignButton;
    },
    set_saveCampaignButton: function (value) {
        this._saveCampaignButton = value;
    },
    get_previewCampaignButton: function () {
        return this._previewCampaignButton;
    },
    set_previewCampaignButton: function (value) {
        this._previewCampaignButton = value;
    },
    ...
    get_scheduleDeliveryButton: function () {
        return this._scheduleDeliveryButton;
    },
    set_scheduleDeliveryButton: function (value) {
        this._scheduleDeliveryButton = value;
    },
    get_discardCampaignButton: function () {
        return this._discardCampaignButton;
    },
    set_discardCampaignButton: function (value) {
        this._discardCampaignButton = value;
    },
    ...
    get_scheduleCampaignDialog: function () {
        return this._scheduleCampaignDialog;
    },
    set_scheduleCampaignDialog: function (value) {
        this._scheduleCampaignDialog = value;
    }
};
