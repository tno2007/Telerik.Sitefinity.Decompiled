...
// Type: Telerik.Sitefinity.Web.UI.Fields.ImageGalleryAssetsField
...
{
  /// <summary>
  /// This class extends the AssetsField class with a functionality specific for image gallery.
  /// </summary>
  public class ImageGalleryAssetsField : AssetsField
  {
