...
// Type: Telerik.Sitefinity.Modules.Comments.Web.UI.Backend.ThreadDetails
...
namespace Telerik.Sitefinity.Modules.Comments.Web.UI.Backend
{
  ...
  /// </summary>
  internal class ThreadDetails : CommandWidget
  {
    ...
    {
      ThreadDetails threadDetails = this;
      // ISSUE: reference to a compiler-generated method
      foreach (ScriptReference scriptReference in threadDetails.\u003C\u003En__1())
        yield return scriptReference;
      yield return new ScriptReference()
      {
        Assembly = threadDetails.GetType().Assembly.FullName,
