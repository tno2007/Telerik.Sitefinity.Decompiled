...
// Type: Telerik.Sitefinity.DynamicModules.Builder.Events.DynamicContentProviderEventBase
...
{
  /// <summary>
  /// A base class for all <see cref="!:DynamicContentProvider" /> related events
  /// </summary>
  public class DynamicContentProviderEventBase : 
    ...
    IPropertyChangeDataEvent
  {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.DynamicModules.Builder.Events.DynamicContentProviderEventBase" /> class.
    /// </summary>
    public DynamicContentProviderEventBase()
    {
    }
    ...
    internal DynamicContentProviderEventBase(
      Guid itemId,
      Type itemType,
      string action,
    ...
    internal DynamicContentProviderEventBase(DynamicContentProviderEventBase source)
    {
