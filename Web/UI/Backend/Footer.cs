...
// Type: Telerik.Sitefinity.Web.UI.Backend.Footer
...
{
  /// <summary>Represents the footer in the backend area.</summary>
  public class Footer : SimpleView
  {
    public static readonly string layoutTemplatePath = ControlUtilities.ToVppPath("Telerik.Sitefinity.Resources.Templates.Backend.Footer.ascx");
    ...
    {
      get => string.IsNullOrEmpty(base.LayoutTemplatePath) ? Footer.layoutTemplatePath : base.LayoutTemplatePath;
