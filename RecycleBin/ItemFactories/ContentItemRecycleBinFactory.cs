...
// Type: Telerik.Sitefinity.RecycleBin.ItemFactories.ContentItemRecycleBinFactory
...
{
  /// <summary>
  /// Recycle Bin item factory that uses items of type <see cref="T:Telerik.Sitefinity.Model.IContent" /> and can fill the properties of <see cref="T:Telerik.Sitefinity.RecycleBin.IRecycleBinDataItem" />
  /// from it.
  /// </summary>
  public class ContentItemRecycleBinFactory : DataItemRecycleBinFactory
  {
    /// <summary>
      ...
      IDataItem item)
    {
      ...
      if (item is IContent)
        recycleBinItemAdapters.Add((IRecycleBinItemAdapter) ObjectFactory.Container.Resolve<ContentItemAdapter>());
      if (item is IApprovalWorkflowItem)
      ...
      if (item is MediaContent)
        recycleBinItemAdapters.Add((IRecycleBinItemAdapter) ObjectFactory.Container.Resolve<MediaContentAdapter>());
