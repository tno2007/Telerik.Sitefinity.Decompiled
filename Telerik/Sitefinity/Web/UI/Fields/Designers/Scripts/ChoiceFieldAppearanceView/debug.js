...
Telerik.Sitefinity.Web.UI.Fields.Designers.Views.ChoiceFieldAppearanceView = function (element) {
    Telerik.Sitefinity.Web.UI.Fields.Designers.Views.ChoiceFieldAppearanceView.initializeBase(this, [element]);
    this._viewsSelector = null;
}

Telerik.Sitefinity.Web.UI.Fields.Designers.Views.ChoiceFieldAppearanceView.prototype = {
    /* --------------------------------- set up and tear down --------------------------------- */
    initialize: function () {
        Telerik.Sitefinity.Web.UI.Fields.Designers.Views.ChoiceFieldAppearanceView.callBaseMethod(this, 'initialize');
    },

    dispose: function () {
        Telerik.Sitefinity.Web.UI.Fields.Designers.Views.ChoiceFieldAppearanceView.callBaseMethod(this, 'dispose');
    },
