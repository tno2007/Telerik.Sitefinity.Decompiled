...
// Type: Telerik.Sitefinity.Web.UI.Fields.Contracts.IRelatedMediaFieldDefinition
...
{
  public interface IRelatedMediaFieldDefinition : 
    ...
    IDefinition
  {
    ...
    /// <summary>Gets or sets the related content provider</summary>
