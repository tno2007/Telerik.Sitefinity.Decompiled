...
// Type: Telerik.Sitefinity.DynamicModules.Builder.Events.AfterCommitEvents.DynamicContentProviderEvents.IDynamicContentProviderUpdatedEvent
...
{
  /// <summary>
  /// Event for updated <see cref="T:Telerik.Sitefinity.DynamicModules.Builder.Model.DynamicContentProvider" /> that is raised after committing transaction/save changes
  /// </summary>
  public interface IDynamicContentProviderUpdatedEvent : 
