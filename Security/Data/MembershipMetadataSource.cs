...
// Type: Telerik.Sitefinity.Security.Data.MembershipMetadataSource
...
{
  public class MembershipMetadataSource : SecuredProviderMetadataSource
  {
    public MembershipMetadataSource(IDatabaseMappingContext context)
      : base(context)
    {
    }
    ...
    protected override IList<IOpenAccessFluentMapping> BuildCustomMappings()
    {
      ...
      accessFluentMappingList.Add((IOpenAccessFluentMapping) new MembershipFluentMapping(this.Context));
