...
// Type: Telerik.Sitefinity.Fluent.Content.DocumentsFacade
...
{
  [Obsolete]
  public class DocumentsFacade : ContentsFacade<DocumentsFacade, Document, DocumentLibraryFacade>
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Fluent.Content.DocumentsFacade" /> class.
    /// </summary>
    /// <param name="appSettings">
    /// The app settings that configure the way fluent API will function.
    /// </param>
    public DocumentsFacade(AppSettings appSettings)
      : base(appSettings)
    {
    }
    ...
    public DocumentsFacade(AppSettings appSettings, DocumentLibraryFacade parentFacade)
