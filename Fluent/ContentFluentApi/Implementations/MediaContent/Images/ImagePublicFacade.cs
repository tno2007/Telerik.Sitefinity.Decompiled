...
// Type: Telerik.Sitefinity.Fluent.ContentFluentApi.ImagePublicFacade`1
...
{
  /// <summary>Manages the public state of an image</summary>
  /// <typeparam name="TParentFacade"></typeparam>
  public class ImagePublicFacade<TParentFacade> : 
    MediaPublicFacade<ImagePublicFacade<TParentFacade>, TParentFacade, Image, ImageTempFacade<TParentFacade>>,
    ISupportComments<ImagePublicFacade<TParentFacade>, Image>,
    ISupportVersioning<ImagePublicFacade<TParentFacade>>
  ...
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Fluent.ContentFluentApi.ImagePublicFacade`1" /> class.
    /// </summary>
    ...
    public ImagePublicFacade(AppSettings settings)
      : base(settings)
    {
    }
    ...
    /// <exception cref="T:System.ArgumentNullException">When <paramref name="settings" /> is null</exception>
    /// <exception cref="T:System.ArgumentException">When <paramref name="settings" />'s transaction name is null or empty</exception>
    public ImagePublicFacade(AppSettings settings, TParentFacade parentFacade)
    ...
    /// <exception cref="T:System.ArgumentException">When <paramref name="settings" />'s transaction name is null or empty</exception>
    public ImagePublicFacade(AppSettings settings, TParentFacade parentFacade, Guid itemID)
    ...
    /// <exception cref="T:System.ArgumentNullException">When <paramref name="settings" /> or <paramref name="item" /> is null</exception>
    /// <exception cref="T:System.ArgumentException">When <paramref name="settings" />'s transaction name is null or empty</exception>
    public ImagePublicFacade(AppSettings settings, TParentFacade parentFacade, Image item)
    ...
    public virtual CommentsSingularFacade<ImagePublicFacade<TParentFacade>, Image> Comment() => new CommentsSingularFacade<ImagePublicFacade<TParentFacade>, Image>(this.settings, this, this.Get());
    ...
    public virtual CommentsSingularFacade<ImagePublicFacade<TParentFacade>, Image> Comment(
      Guid id)
    {
      return new CommentsSingularFacade<ImagePublicFacade<TParentFacade>, Image>(this.settings, this, this.Get(), id);
    }

    /// <summary>Get a facade that manages this image's comments</summary>
    /// <returns>Facade that manages this image's comments</returns>
    public virtual CommentsPluralFacade<ImagePublicFacade<TParentFacade>, Image> Comments() => new CommentsPluralFacade<ImagePublicFacade<TParentFacade>, Image>(this.settings, this, this.Get());

    /// <summary>Manage this item's versions</summary>
    /// <returns>Versioning facade</returns>
    public virtual VersioningFacade<ImagePublicFacade<TParentFacade>> Versioning() => new VersioningFacade<ImagePublicFacade<TParentFacade>>(this.settings, this, (IDataItem) this.Get());
  }
}
