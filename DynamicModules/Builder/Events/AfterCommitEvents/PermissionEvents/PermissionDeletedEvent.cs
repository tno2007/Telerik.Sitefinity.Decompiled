...
// Type: Telerik.Sitefinity.DynamicModules.Builder.Events.AfterCommitEvents.PermissionEvents.PermissionDeletedEvent
...
{
  /// <summary>
  /// Deleted event for permission that is raised after committing transaction/save changes
  /// </summary>
  internal class PermissionDeletedEvent : 
    PermissionDataEventBase,
    IPermissionDeletedEvent,
  ...
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.DynamicModules.Builder.Events.AfterCommitEvents.PermissionEvents.PermissionDeletedEvent" /> class.
    /// </summary>
