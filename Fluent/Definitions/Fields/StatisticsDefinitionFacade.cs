...
// Type: Telerik.Sitefinity.Fluent.Definitions.Fields.StatisticsDefinitionFacade`1
...
namespace Telerik.Sitefinity.Fluent.Definitions.Fields
{
  ...
  public class StatisticsDefinitionFacade<TParentFacade> : 
    FieldControlDefinitionFacade<ContentStatisticsFieldElement, StatisticsDefinitionFacade<TParentFacade>, TParentFacade>
    where TParentFacade : class
  {
    ...
    public StatisticsDefinitionFacade(
      string moduleName,
      ...
      : base(moduleName, definitionName, contentType, parentElement, viewName, sectionName, parentFacade, fieldName, resourceClassId, mode)
    {
      ...
      this.Field.FieldType = typeof (ContentStatisticsField);
    }

    /// <summary>Creates the config.</summary>
    /// <param name="parentElement">The parent element.</param>
    /// <returns>New instance of the parent config element.</returns>
    protected override ContentStatisticsFieldElement CreateConfig(
      ConfigElementDictionary<string, FieldDefinitionElement> parentElement)
    {
      return new ContentStatisticsFieldElement((ConfigElement) parentElement);
    }
  }
}
