...
Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.SingleMediaContentItemSettingsDesignerView=function(element){Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.SingleMediaContentItemSettingsDesignerView.initializeBase(this,[element]);
this._providerName="";
this._settingsView=null;
};
Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.SingleMediaContentItemSettingsDesignerView.prototype={initialize:function(){Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.SingleMediaContentItemSettingsDesignerView.callBaseMethod(this,"initialize");
},dispose:function(){Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.SingleMediaContentItemSettingsDesignerView.callBaseMethod(this,"dispose");
},_beforeSaveHandler:function(sender,args){if(this.get_parentDesigner().isViewSelected(this)){var isValidImageData=this.get_settingsView().validateItemData();
...
if(controlData){var settingsView=this.get_settingsView();
if(settingsView.isImage()){settingsView.setMargins(controlData.MarginTop,controlData.MarginRight,controlData.MarginBottom,controlData.MarginLeft);
...
if(controlData.ThumbnailName){settingsView.set_selectedThumbnailName(controlData.ThumbnailName);
}else{if(controlData.DisplayMode==="Custom"){settingsView.selectSizeOptionCustom();
...
}else{if(settingsView.isDocument()){settingsView.setThumbnailType(controlData.ThumbnailType);
}else{if(settingsView.isVideo()){settingsView.setVideoAspectRatio(controlData.Width,controlData.Height);
...
}},applyChanges:function(){var settingsView=this.get_settingsView();
var itemData=settingsView.getItemData();
var controlData=this.get_controlData();
if(settingsView.isImage()){if(itemData){controlData.MarginRight=itemData.MarginRight;
...
}}else{if(settingsView.isDocument()){controlData.ThumbnailType=itemData.ThumbnailType;
}else{if(settingsView.isVideo()){controlData.Height=itemData.Height;
...
},get_settingsView:function(){return this._settingsView;
},set_settingsView:function(value){this._settingsView=value;
}};
