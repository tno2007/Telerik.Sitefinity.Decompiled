...
// Type: Telerik.Sitefinity.Publishing.Twitter.Configuration.TwitterApplication
...
{
  [DataContract]
  public class TwitterApplication : ConfigElement, ITwitterApplication
  {
    public TwitterApplication(ConfigElement parent)
      : base(parent)
    {
    }
    ...
    public virtual string ConsumerKey
    {
      ...
      set => this["consumerKey"] = (object) value;
    }
    ...
    public virtual string ConsumerSecret
    {
      ...
      set => this["consumerSecret"] = (object) value;
    }
  }
}
