...
Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.UploadImageDesignerView=function(element){Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.UploadImageDesignerView.initializeBase(this,[element]);
this._saveButtonText=null;
};
Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.UploadImageDesignerView.prototype={initialize:function(){Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.UploadImageDesignerView.callBaseMethod(this,"initialize");
...
},dispose:function(){Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.UploadImageDesignerView.callBaseMethod(this,"dispose");
},refreshUI:function(){if(this.get_parentDesigner().isViewSelected(this)){this.notifyViewSelected();
...
},_setControlData:function(controlData){if(this._contentId){controlData.ImageId=this._contentId;
