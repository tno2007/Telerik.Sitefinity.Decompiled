...
// Type: Telerik.Sitefinity.Web.UI.Fields.Config.ContentLocationInfoFieldElement
...
namespace Telerik.Sitefinity.Web.UI.Fields.Config
{
  ...
  /// </summary>
  public class ContentLocationInfoFieldElement : 
    FieldControlDefinitionElement,
    IContentLocationInfoFieldDefinition,
    IFieldDefinition,
    IDefinition
  {
    /// <summary>
    ...
    /// will not be thrown.
    /// </remarks>
    public ContentLocationInfoFieldElement(ConfigElement parent)
      : base(parent)
    {
    }
    ...
    /// <returns></returns>
    public override DefinitionBase GetDefinition() => (DefinitionBase) new ContentLocationInfoFieldDefinition((ConfigElement) this);

    /// <summary>Gets the default type of the field.</summary>
    /// <value>The default type of the field.</value>
    public override Type DefaultFieldType => typeof (ContentLocationInfoField);
  }
}
