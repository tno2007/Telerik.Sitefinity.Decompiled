...
// Type: Telerik.Sitefinity.Services.Comments.DTO.NotificationStatusRequest
...
{
  /// <summary>
  /// <c>NotificationStatusRequest </c> Contains information required for checking the status of notifications subscription
  /// </summary>
