...
// Type: Telerik.Sitefinity.ContentLocations.Configuration.ContentLocationsConfig
...
using Telerik.Sitefinity.ContentLocations.Data;
using Telerik.Sitefinity.Web.Configuration;

namespace Telerik.Sitefinity.ContentLocations.Configuration
{
  /// <summary>
  /// Represents the configuration section for Site Settings management.
  /// </summary>
  internal class ContentLocationsConfig : ConfigSection
  {
    ...
    protected override void OnPropertiesInitialized()
    {
      ...
      providers.Add(new DataProviderSettings((ConfigElement) providers)
      {
        ...
        ProviderType = typeof (OpenAccessContentLocationsProvider)
      });
    }
  }
}
