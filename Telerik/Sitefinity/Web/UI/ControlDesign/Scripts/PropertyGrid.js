...
$(el).find('input[type="text"]').keyup(function(){self._changeProperty(dataItem.PropertyPath,dataItem.PropertyId,$(this).val());
});
...
},_changeProperty:function(propertyPath,propertyId,propertyValue){this.get_propertyEditor().changePropertyValue(propertyPath,propertyValue);
