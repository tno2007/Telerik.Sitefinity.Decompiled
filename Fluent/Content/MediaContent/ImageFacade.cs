...
// Type: Telerik.Sitefinity.Fluent.Content.ImageFacade
...
{
  [Obsolete]
  public class ImageFacade : MediaContentFacade<ImageFacade, Image, AlbumFacade>
  {
    /// <summary>
    ...
    /// </param>
    public ImageFacade(AppSettings appSettings)
      : base(appSettings)
    {
    }
    ...
    public ImageFacade(AppSettings appSettings, Guid itemId)
    ...
    public ImageFacade(AppSettings appSettings, AlbumFacade parentFacade)
    ...
    /// <param name="itemId">The image id.</param>
    /// <param name="parentFacade">The parent facade.</param>
    public ImageFacade(AppSettings appSettings, Guid itemId, AlbumFacade parentFacade)
