...
Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.ImageGalleryDesigner = function (element) {
    Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.ImageGalleryDesigner.initializeBase(this, [element]);
    this._libraryType = null;
    this._selectorViewName = null;
    this._settingsViewName = null;
}

Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.ImageGalleryDesigner.prototype = {

    initialize: function () {
        Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.ImageGalleryDesigner.callBaseMethod(this, 'initialize');
    ...
    dispose: function () {
        ...
        Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.ImageGalleryDesigner.callBaseMethod(this, 'dispose');
    },
    ...
    _clientTabSelectedHandler: function (sender, args) {
        ...
        Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.ImageGalleryDesigner.callBaseMethod(this, '_clientTabSelectedHandler', [sender, args]);
...
Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.ImageGalleryDesigner.registerClass("Telerik.Sitefinity.Modules.Libraries.Web.UI.Designers.ImageGalleryDesigner", Telerik.Sitefinity.Web.UI.ControlDesign.ContentViewDesignerBase);
