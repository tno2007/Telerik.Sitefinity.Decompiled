...
// Type: Telerik.Sitefinity.Fluent.ContentFluentApi.VideoDraftFacade`1
...
{
  /// <summary>Manages the draft state of a video</summary>
  /// <typeparam name="TParentFacade">The type of the parent facade.</typeparam>
  public class VideoDraftFacade<TParentFacade> : 
    MediaDraftFacade<VideoDraftFacade<TParentFacade>, TParentFacade, Video, VideoTempFacade<VideoDraftFacade<TParentFacade>>, VideoPublicFacade<VideoDraftFacade<TParentFacade>>>,
    ISupportVersioning<VideoDraftFacade<TParentFacade>>
    where TParentFacade : BaseFacade
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Fluent.ContentFluentApi.VideoDraftFacade`1" /> class.
    /// </summary>
    ...
    public VideoDraftFacade(AppSettings settings)
      : base(settings)
    {
    }
    ...
    /// <exception cref="T:System.ArgumentNullException">When <paramref name="settings" /> is null</exception>
    /// <exception cref="T:System.ArgumentException">When <paramref name="settings" />'s transaction name is null or empty</exception>
    public VideoDraftFacade(AppSettings settings, TParentFacade parentFacade)
    ...
    public VideoDraftFacade(AppSettings settings, TParentFacade parentFacade, Guid itemID)
    ...
    /// <exception cref="T:System.ArgumentException">When <paramref name="settings" />'s transaction name is null or empty</exception>
    public VideoDraftFacade(AppSettings settings, TParentFacade parentFacade, Video item)
    ...
    public virtual VersioningFacade<VideoDraftFacade<TParentFacade>> Versioning() => new VersioningFacade<VideoDraftFacade<TParentFacade>>(this.settings, this, (IDataItem) this.Get());
  }
}
