...
// Type: Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormEmailTextBoxAppearanceView
...
{
  /// <inheritdoc />
  public class FormEmailTextBoxAppearanceView : ContentViewDesignerView
  {
    ...
    public static readonly string layoutTemplatePath = ControlUtilities.ToVppPath("Telerik.Sitefinity.Resources.Templates.Designers.Forms.FormEmailTextBoxAppearanceView.ascx");
    internal const string DesignerViewJs = "Telerik.Sitefinity.Modules.Forms.Web.UI.Scripts.FormEmailTextBoxAppearanceView.js";
    ...
    {
      get => string.IsNullOrEmpty(base.LayoutTemplatePath) ? FormEmailTextBoxAppearanceView.layoutTemplatePath : base.LayoutTemplatePath;
    ...
    /// <summary>
    /// Gets a value that represents the text field for the CSS class
    /// </summary>
    protected virtual TextField CssClassTextField => this.Container.GetControl<TextField>("cssClassTextField", true);

    /// <summary>
    /// Gets a value that represents the choice field for setting the size of the textbox
    /// </summary>
    protected virtual ChoiceField TextBoxSizeChoiceField => this.Container.GetControl<ChoiceField>("textBoxSizeChoiceField", true);
    ...
    public override IEnumerable<ScriptDescriptor> GetScriptDescriptors()
    {
      ...
      if (this.TextBoxSizeChoiceField != null)
    ...
    public override IEnumerable<ScriptReference> GetScriptReferences()
    {
      ...
      return (IEnumerable<ScriptReference>) new List<ScriptReference>()
      {
        ...
        new ScriptReference("Telerik.Sitefinity.Modules.Forms.Web.UI.Scripts.FormEmailTextBoxAppearanceView.js", assembly)
      };
    }
  }
}
