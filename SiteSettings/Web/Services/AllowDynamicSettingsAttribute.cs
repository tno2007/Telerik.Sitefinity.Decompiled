...
// Type: Telerik.Sitefinity.SiteSettings.Web.Services.AllowDynamicSettingsAttribute
...
{
  /// <summary>
  /// Applied to WCF service classes that want to expose types used for basic settings.
  /// </summary>
  [AttributeUsage(AttributeTargets.Class | AttributeTargets.Interface, AllowMultiple = false, Inherited = true)]
  public sealed class AllowDynamicSettingsAttribute : 
    Attribute,
    IContractBehavior,
    IOperationBehavior,
    IWsdlExportExtension
  {
      ...
      ClientRuntime clientRuntime)
    {
      foreach (OperationDescription operation in (Collection<OperationDescription>) contractDescription.Operations)
        AllowDynamicSettingsAttribute.ApplyDataContractSurrogate(operation);
    }
    ...
    {
      AllowDynamicSettingsAttribute.ApplyDataContractSurrogate(operationDescription);
    }
    ...
    public void ExportContract(WsdlExporter exporter, WsdlContractConversionContext context)
    {
      ...
      if (contractExporter.Options.DataContractSurrogate != null)
        return;
      contractExporter.Options.DataContractSurrogate = (IDataContractSurrogate) new BasicSettingsSurrogate();
    }
    ...
    private static void ApplyDataContractSurrogate(OperationDescription description)
    {
      ...
      if (operationBehavior == null || operationBehavior.DataContractSurrogate != null)
        return;
      operationBehavior.DataContractSurrogate = (IDataContractSurrogate) new BasicSettingsSurrogate();
    }
  }
}
