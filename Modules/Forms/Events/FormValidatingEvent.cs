...
// Type: Telerik.Sitefinity.Modules.Forms.Events.FormValidatingEvent
...
{
  /// <summary>
  /// Event raised before a form gets validated.
  /// Event handlers should throw Telerik.Sitefinity.Services.Events.ValidationException if the form is not valid.
  /// </summary>
  public class FormValidatingEvent : 
    IFormEditAwareEvent,
    IFormEvent,
    IFormsModuleEvent,
    IEvent,
