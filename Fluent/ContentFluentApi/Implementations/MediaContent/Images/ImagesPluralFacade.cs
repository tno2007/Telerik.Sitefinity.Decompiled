...
// Type: Telerik.Sitefinity.Fluent.ContentFluentApi.ImagesPluralFacade`1
...
{
  /// <summary>Manages a collection of images</summary>
  /// <typeparam name="TParentFacade">Type of the parent facade</typeparam>
  public class ImagesPluralFacade<TParentFacade> : 
    BaseContentPluralFacadeWithLifeCycle<ImagesPluralFacade<TParentFacade>, ImageDraftFacade<ImagesPluralFacade<TParentFacade>>, TParentFacade, Image>
    where TParentFacade : BaseFacade
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Fluent.ContentFluentApi.ImagesPluralFacade`1" /> class.
    /// </summary>
    ...
    public ImagesPluralFacade(AppSettings settings)
      : base(settings)
    {
    }
    ...
    /// <exception cref="!:ArgumentNullException">When <paramref name="settings" /> is null</exception>
    /// <exception cref="!:ArgumentException">When <paramref name="settings" />'s transaction name is null or empty</exception>
    public ImagesPluralFacade(AppSettings settings, TParentFacade parentFacade)
