...
// Type: Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.Views.FormTextBoxAppearanceView
...
{
  public class FormTextBoxAppearanceView : ContentViewDesignerView
  {
    public static readonly string layoutTemplatePath = ControlUtilities.ToVppPath("Telerik.Sitefinity.Resources.Templates.Designers.Forms.FormTextBoxAppearanceView.ascx");
    internal const string designerViewJs = "Telerik.Sitefinity.Modules.Forms.Web.UI.Scripts.FormTextBoxAppearanceView.js";
    ...
    {
      get => string.IsNullOrEmpty(base.LayoutTemplatePath) ? FormTextBoxAppearanceView.layoutTemplatePath : base.LayoutTemplatePath;
    ...
    public override IEnumerable<ScriptReference> GetScriptReferences()
    {
      ...
      return (IEnumerable<ScriptReference>) new List<ScriptReference>()
      {
        ...
        new ScriptReference("Telerik.Sitefinity.Modules.Forms.Web.UI.Scripts.FormTextBoxAppearanceView.js", assembly)
      };
    }
  }
}
