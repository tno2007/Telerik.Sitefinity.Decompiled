...
// Type: Telerik.Sitefinity.ContentUsages.IContentUsageService
...
namespace Telerik.Sitefinity.ContentUsages
{
  ...
  internal interface IContentUsageService
  {
    /// <summary>Get content usages for given filter</summary>
    /// <param name="filter">The filter</param>
    /// <returns>List of content usages</returns>
