...
// Type: Telerik.Sitefinity.Security.Data.UserProfileMetadataSource
...
{
  public class UserProfileMetadataSource : SecuredProviderMetadataSource
  {
    public UserProfileMetadataSource(IDatabaseMappingContext context)
      : base(context)
    {
    }
    ...
    protected override IList<IOpenAccessFluentMapping> BuildCustomMappings()
    {
      ...
      accessFluentMappingList.Add((IOpenAccessFluentMapping) new UserProfileFluentMapping(this.Context));
