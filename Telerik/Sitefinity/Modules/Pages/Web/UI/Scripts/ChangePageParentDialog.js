...
Telerik.Sitefinity.Modules.Pages.Web.UI.ChangePageParentDialog=function(element){Telerik.Sitefinity.Modules.Pages.Web.UI.ChangePageParentDialog.initializeBase(this,[element]);
this._pageSelector=null;
this._doneSelectingDelegate=null;
this._webServiceBaseUrl=null;
};
Telerik.Sitefinity.Modules.Pages.Web.UI.ChangePageParentDialog.prototype={initialize:function(){if(this._doneSelectingDelegate==null){this._doneSelectingDelegate=Function.createDelegate(this,this._pageSelector_doneSelecting);
...
},dispose:function(){if(this._doneSelectingDelegate!=null){this._pageSelector.remove_doneClientSelection(this._doneSelectingDelegate);
...
},_pageSelector_doneSelecting:function(newParentPage){if(newParentPage==null){dialogBase.close();
}else{this._changePageParent(dialogPageId,newParentPage.Id);
}},_changePageParent:function(pageId,newParentPageId){var serviceUrl=this._webServiceBaseUrl;
...
},_serviceSuccess:function(caller,sender,args){dialogBase.closeAndRebind();
},_serviceFailure:function(sender,args){alert("Problem!");
