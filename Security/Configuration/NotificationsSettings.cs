...
// Type: Telerik.Sitefinity.Security.Configuration.NotificationsSettings
...
{
  /// <summary>
  /// Settings for the notification service subscriptions for security.
  /// </summary>
  public class NotificationsSettings : ConfigElement
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Security.Configuration.NotificationsSettings" /> class.
    /// </summary>
