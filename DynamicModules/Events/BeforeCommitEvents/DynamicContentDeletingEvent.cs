...
// Type: Telerik.Sitefinity.DynamicModules.Events.DynamicContentDeletingEvent
...
{
  /// <summary>
  /// Deleting event for dynamic content that is raised before committing transaction/save changes
  /// </summary>
  internal class DynamicContentDeletingEvent : 
  ...
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.DynamicModules.Events.DynamicContentDeletingEvent" /> class.
    /// </summary>
    ...
    public DynamicContentDeletingEvent(
      DynamicContent item,
      string itemState,
    ...
    {
      ((IDynamicContentDeletingEvent) this).Item = item;
      this.UserId = userId;
    }

    /// <summary>Gets or sets the dynamic item processed in the event.</summary>
    /// <value>The item.</value>
    DynamicContent IDynamicContentDeletingEvent.Item { get; set; }
