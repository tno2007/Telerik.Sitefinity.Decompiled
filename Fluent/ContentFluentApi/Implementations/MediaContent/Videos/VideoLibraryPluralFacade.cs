...
// Type: Telerik.Sitefinity.Fluent.ContentFluentApi.VideoLibraryPluralFacade`1
...
{
  /// <summary>Manages a collection of video libraries</summary>
  /// <typeparam name="TParentFacade">Type of the parent facade</typeparam>
  public class VideoLibraryPluralFacade<TParentFacade> : 
    BaseContentPluralFacadeWithoutLifeCycle<VideoLibraryPluralFacade<TParentFacade>, VideoLibrarySingularFacade<TParentFacade>, TParentFacade, VideoLibrary>
    where TParentFacade : BaseFacade
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Fluent.ContentFluentApi.VideoLibraryPluralFacade`1" /> class.
    /// </summary>
    ...
    public VideoLibraryPluralFacade(AppSettings settings)
      : base(settings)
    {
    }
    ...
    /// <exception cref="!:ArgumentNullException">When <paramref name="settings" /> is null</exception>
    /// <exception cref="!:ArgumentException">When <paramref name="settings" />'s transaction name is null or empty</exception>
    public VideoLibraryPluralFacade(AppSettings settings, TParentFacade parentFacade)
