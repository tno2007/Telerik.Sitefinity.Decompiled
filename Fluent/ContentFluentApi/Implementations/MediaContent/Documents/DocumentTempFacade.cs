...
// Type: Telerik.Sitefinity.Fluent.ContentFluentApi.DocumentTempFacade`1
...
{
  /// <summary>Manage the temp state of a document</summary>
  /// <typeparam name="TParentFacade">The type of the parent facade.</typeparam>
  public class DocumentTempFacade<TParentFacade> : 
    MediaTempFacade<DocumentTempFacade<TParentFacade>, TParentFacade, Document, DocumentPublicFacade<TParentFacade>>,
    ISupportVersioning<DocumentTempFacade<TParentFacade>>
  ...
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Fluent.ContentFluentApi.DocumentTempFacade`1" /> class.
    /// </summary>
    ...
    public DocumentTempFacade(AppSettings settings)
      : base(settings)
    {
    }
    ...
    /// <exception cref="T:System.ArgumentNullException">When <paramref name="settings" /> is null</exception>
    /// <exception cref="T:System.ArgumentException">When <paramref name="settings" />'s transaction name is null or empty</exception>
    public DocumentTempFacade(AppSettings settings, TParentFacade parentFacade)
    ...
    public DocumentTempFacade(AppSettings settings, TParentFacade parentFacade, Guid itemID)
    ...
    /// <exception cref="T:System.ArgumentException">When <paramref name="settings" />'s transaction name is null or empty</exception>
    public DocumentTempFacade(AppSettings settings, TParentFacade parentFacade, Document item)
    ...
    public virtual VersioningFacade<DocumentTempFacade<TParentFacade>> Versioning() => new VersioningFacade<DocumentTempFacade<TParentFacade>>(this.settings, this, (IDataItem) this.Get());
  }
}
