...
// Type: Telerik.Sitefinity.Fluent.ContentFluentApi.AlbumPluralFacade`1
...
{
  /// <summary>Manages a collection of albums</summary>
  /// <typeparam name="TParentFacade">The type of the parent facade.</typeparam>
  public class AlbumPluralFacade<TParentFacade> : 
    BaseContentPluralFacadeWithoutLifeCycle<AlbumPluralFacade<TParentFacade>, AlbumSingularFacade<TParentFacade>, TParentFacade, Album>
    where TParentFacade : BaseFacade
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Fluent.ContentFluentApi.AlbumPluralFacade`1" /> class.
    /// </summary>
    ...
    public AlbumPluralFacade(AppSettings settings)
      : base(settings)
    {
    }
    ...
    /// <exception cref="!:ArgumentNullException">When <paramref name="settings" /> is null</exception>
    /// <exception cref="!:ArgumentException">When <paramref name="settings" />'s transaction name is null or empty</exception>
    public AlbumPluralFacade(AppSettings settings, TParentFacade parentFacade)
