...
// Type: Telerik.Sitefinity.Packaging.Data.PackagingMetadataSource
...
{
  internal class PackagingMetadataSource : SitefinityMetadataSourceBase
  {
    public PackagingMetadataSource()
    {
    }

    public PackagingMetadataSource(IDatabaseMappingContext context)
      : base(context)
    {
    }
    ...
    {
      (IOpenAccessFluentMapping) new PackagingFluentMapping(this.Context),
