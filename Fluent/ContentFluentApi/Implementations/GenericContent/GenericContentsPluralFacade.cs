...
// Type: Telerik.Sitefinity.Fluent.ContentFluentApi.GenericContentsPluralFacade`1
...
{
  /// <summary>Manages a collection of generic content items</summary>
  /// <typeparam name="TParentFacade">The type of the parent facade.</typeparam>
  public class GenericContentsPluralFacade<TParentFacade> : 
    BaseContentPluralFacadeWithLifeCycle<GenericContentsPluralFacade<TParentFacade>, GenericContentDraftFacade<GenericContentsPluralFacade<TParentFacade>>, TParentFacade, ContentItem>
    where TParentFacade : BaseFacade
  {
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Telerik.Sitefinity.Fluent.ContentFluentApi.GenericContentsPluralFacade`1" /> class.
    /// </summary>
    ...
    public GenericContentsPluralFacade(AppSettings settings)
      : base(settings)
    {
    }
    ...
    /// <exception cref="!:ArgumentNullException">When <paramref name="settings" /> is null</exception>
    /// <exception cref="!:ArgumentException">When <paramref name="settings" />'s transaction name is null or empty</exception>
    public GenericContentsPluralFacade(AppSettings settings, TParentFacade parentFacade)
    ...
    /// <exception cref="!:ArgumentException">When <paramref name="settings" />'s transaction name is null or empty</exception>
    public GenericContentsPluralFacade(
