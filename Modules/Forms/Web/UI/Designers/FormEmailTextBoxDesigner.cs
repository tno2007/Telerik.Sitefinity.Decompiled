...
// Type: Telerik.Sitefinity.Modules.Forms.Web.UI.Designers.FormEmailTextBoxDesigner
...
{
  /// <inheritdoc />
  public class FormEmailTextBoxDesigner : ContentViewDesignerBase
  {
    /// <inheritdoc />
    ...
    protected override void AddViews(Dictionary<string, ControlDesignerView> views)
    {
      ...
      FormEmailTextBoxLabelView textBoxLabelView = new FormEmailTextBoxLabelView();
      views.Add(textBoxLabelView.ViewName, (ControlDesignerView) textBoxLabelView);
      FormEmailTextBoxAppearanceView boxAppearanceView = new FormEmailTextBoxAppearanceView();
