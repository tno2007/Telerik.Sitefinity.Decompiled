...
(function($,$T,$ImageEditor){$(function(){$ImageEditor.SaveAs=function(imageEditor){$ImageEditor.SaveAs.initializeBase(this,[imageEditor]);
};
$ImageEditor.SaveAs.prototype={initialize:function(){$ImageEditor.SaveAs.callBaseMethod(this,"initialize");
...
},attachEventHandlers:function(){this._cancelButtonDelegate=Function.createDelegate(this,this._cancelButtonHandler);
...
},detachEventHandlers:function(){$removeHandler(this._saveAsButton,"click",this._saveAsButtonDelegate);
...
},get_text:function(){if(!this._text){this._text=this._getTextFromTool();
}return this._text;
},get_imageTitle:function(){return $(this._titleTxt).val();
},get_libraryId:function(){return $(this._libraryDD).val();
},onOpen:function(){this.get_imageEditor()._isOurRequest=false;
},onClose:function(){this.get_imageEditor()._isOurRequest=false;
},updateUI:function(){},dispose:function(){this.detachEventHandlers();
$ImageEditor.SaveAs.callBaseMethod(this,"dispose");
},_cancelButtonHandler:function(){this.close();
},_saveAsButtonHandler:function(){this.get_imageEditor().saveImageOnServer(this.get_libraryId()+"/"+this.get_imageTitle());
this.close();
},_getTextFromTool:function(){var tools=this.get_imageEditor().get_tools();
